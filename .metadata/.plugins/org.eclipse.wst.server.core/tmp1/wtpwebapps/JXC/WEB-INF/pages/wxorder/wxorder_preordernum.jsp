...
<body class="easyui-layout" >
	<div data-options="region:'center',title:'预定订单量'">
	<div class="indiv" style="height:100%;width:100%;background-color: #F8F8FF;overflow: hidden;" >
			<form id="managephoto" action="managephoto" method="post" style="float:right;">
					<table>
						<tr>
							<td>录入员</td>
							<td><input id="name" name="name" style="border: 1px solid #95b8e7;border-radius: 5px;height: 20px;width: 100px;background-color:white; " type="text"></input></td>
			...
			function querys(){
				...
				jQuery.ajax({
					url:"preordernumstr",
					type:"post",
					data:{begindate:begindate,enddate:enddate,name:name},
					error:function(){},
					success:function(data){
						$("#tableinput").empty();
						data = $.parseJSON(data);
						//alert(data);
						//var tops = "<tr><th>姓名</th><th>订购方式</th><th>数量</th></tr>";
						var topss = "''"+data+"'";
