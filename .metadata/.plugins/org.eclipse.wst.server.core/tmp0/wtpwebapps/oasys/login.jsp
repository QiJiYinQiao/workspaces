...
margin-left: 88px;
  ...
  <body>
	...
	<div style="position: absolute; margin: 20px auto;margin-top: -148px; margin-right: auto; margin-bottom: 20px; margin-left: -200px; top: 32%; left: 48%;">
		<strong style="font-size: 40px;font-family: sans-serif;">钱钱金融OA办公系统</strong>
	</div>
	<div id="login">
			...
			<div class="formLogin">
				<form name="formLogin" action="index.do" id="formLogin" method="post">
					...
					<div class="loginButton">
						...
						<div style="float: right; padding: 3px 0; margin-right: 45px;">
							<div>
								<ul class="uibutton-group">
									<li><a class="uibutton normal" href="javascript:void(0);" id="but_login">登陆</a>
									</li>
									<li style="margin-left: 11px"><a class="uibutton normal" href="javascript:void(0);" id="forgetpass">重置</a>
									</li>
								</ul>
							</div>
