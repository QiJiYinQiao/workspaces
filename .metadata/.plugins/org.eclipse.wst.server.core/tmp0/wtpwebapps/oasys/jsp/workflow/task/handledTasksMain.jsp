...
var $$row;
var handleResultArr=jqueryUtil.getTextArr('handle_result');
$(function(){
	createOptionsGrid();
}); 
//审批意见列表
	...
	$("#dg").datagrid({
		...
		columns : [ [ 
		              {field : 'appNo',title : '申请编号',width : parseInt($(this).width() * 0.15),align:'center',formatter:function(value,row,index){
		             	    	return "<a href='javascript:void(0);' onmouseover=\"this.style.color='red'\" onmouseout=\"this.style.color='blue'\" onclick='checkOpinions("+index+");'>"+value+"</a>";
		                }},
		              ...
		              {field : 'handleResult',title : '处理结果',width :parseInt($(this).width() * 0.2),align:'center',
		            	  formatter:function(value,row,index){
							return jqueryUtil.showText(value,handleResultArr);
						} },
