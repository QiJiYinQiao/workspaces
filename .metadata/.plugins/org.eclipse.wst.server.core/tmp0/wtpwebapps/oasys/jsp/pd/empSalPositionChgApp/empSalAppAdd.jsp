    ...
    <input type="hidden" id="chgReson" name="chgReson" value="${empSal.chgReson }" />
 		...
 		<table class="table"  width="95%">
				...
				<tr>
					...
					<td>
						<input id="trialPeriods" name="trialPeriods" value="${empSal.trialPeriods}"  type="text" class="easyui-textbox easyui-numberbox easyui-validatebox"  data-options="required:true,min:1,max:9"/>&nbsp;(月)
					</td>		
					<th align="right">试岗月薪:</th>
					<td>
						<input id="trialSal" name="trialSal" value="${empSal.trialSal}"  type="text" class="easyui-textbox easyui-numberbox "  data-options="required:true,min:1,max:9999999,precision:2,groupSeparator:','"/>&nbsp;(元)
					</td>					
				</tr>						
				<tr>
