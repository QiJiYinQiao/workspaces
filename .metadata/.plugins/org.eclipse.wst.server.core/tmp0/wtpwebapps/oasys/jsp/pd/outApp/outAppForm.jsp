...
<form id="outAppForm">
   ...
   <table class="table">
     <tr>
        <th>计划外出<br/>开始时间:</th>
        <td>
           <input name="planBgDtime" class="easyui-textbox easyui-validatebox easyui-datetimebox"/>
        </td>
        <th>计划外出<br/>结束时间:</th>
        <td>
           <input name="planEdDtime" class="easyui-textbox easyui-validatebox easyui-datetimebox"/>
        </td>
     </tr>
     <tr>
        <th>外出事由:</th>
