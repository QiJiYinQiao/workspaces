...
<html>
				...
				$(window).resize(function(){  
				 ...
				 $grid=$dg.datagrid({
					...
					columns : [ [
			    				...
			    				{field : 'curDeptName',        title : '目前部门名称',    width : parseInt($(this).width() * 0.07), align:'center' },
			    				{field : 'curPosition',      title : '目前所在职位', width : parseInt($(this).width() * 0.07), align:'center'}, 
			    				{field : 'curSal',    title : '目前薪资(元)',    width : parseInt($(this).width() * 0.07), align:'center' },
			    				...
			    				{field : 'trialPeriods',    title : '试岗期限(月)',    width : parseInt($(this).width() * 0.07), align:'center' },
			    				{field : 'trialSal',    title : '试岗月薪(元)',    width : parseInt($(this).width() * 0.07), align:'center' },
  ...
  <body>
      <div data-options="region:'center',border : false">
      	<div class="position" style="margin-top: 5px;">您当前所在位置： 人力资源规划  &gt; 员工关系  &gt; 人事手续管理   &gt; 员工调岗调薪申请</div>
		<!-- 高级查询栏区域 -->
