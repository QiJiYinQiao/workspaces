	...
	<script type="text/javascript">
			...
			function updRowsOpenDlg() {
				...
				for(var i in userIds){
					$.ajax({
						url:'noticeInfoController/findUserNameByUserId.do',
						type:'post',
				...
				if (row) {
					parent.$.modalDialog({
						...
						width : 800,
						height : 700,
						href : "noticeInfoController/toEditNotice.do?noiId="+row.noiId+"&noticeNo="+row.noticeNo+"&userIds="+userIds,
						onLoad:function(){
							var f = parent.$.modalDialog.handler.find("#form");
							row["userIds"]=userIds;
							row["userNames"]=userNames.join(',');
							var divs=parent.$.modalDialog.handler.find("#addRes");
							divs.hide();
							f.form("load",row);
						},			
						buttons : [ {
