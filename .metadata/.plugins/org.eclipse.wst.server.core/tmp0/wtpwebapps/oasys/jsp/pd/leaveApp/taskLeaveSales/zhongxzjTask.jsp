		...
		<form id="taskForm" method="post">
			...
			<input id="planLeDays" name="planLeDays" type="hidden"/><!-- 计划请假天数 -->
			 ...
			 <table class="table"  width="95%">
				 <tr>
				    <th >申请编号:</th>
					<td ><input id="appNo" name="appNoMain" readonly="readonly" class="easyui-textbox " disabled="disabled" data-options="editable:false" type="text"/></td>
				</tr>
				
				<tr>
				 	<th align="right">审批意见:</th>
					<td colspan="3" >
						<textarea id="taskComment" name="taskComment" class="easyui-validatebox easyui-textbox" data-options="validType:'length[0,200]'" style="width:730px;height:70px;resize:none;"></textarea>
					</td>
				</tr>
				<!-- 操作 -->
				<tr>
