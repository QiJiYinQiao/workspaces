...
<script type="text/javascript">
	...
	function valReallePlandate(){
		if(new Date($("#planBgDtime").datetimebox('getValue'))>new Date($("#realBgDtime").datetimebox('getValue')) && $("#realBgDtime").datetimebox('getValue')!=""){
			$.messager.alert("提示", '实际的休假开始时间超出计划的休假开始时间！',"error");
			flag=false;
		}
		if(new Date($("#planEdDtime").datetimebox('getValue'))<new Date($("#realEdDtime").datetimebox('getValue')) && $("#realEdDtime").datetimebox('getValue')!=""){
	  ...
	  <div class="well well-small" style="margin:5px;">
	         ...
	         <table class="table">
				...
				<tr>
					<th>休假事由:</th>
					<td colspan="3">
						<textarea id="leReason" name="leReason" class="easyui-textbox easyui-validatebox" style="width: 739px;height: 80px;resize:none" re data-options="required:true,validType:'length[1,200]',editable:false"></textarea>
					</td>
				</tr>
				...
				<tr id="real" >
				 ...
				 <tr>
					<th>备注信息:</th>
					<td colspan="3">
					  <textarea id="remark" name="remark" class="easyui-textbox easyui-validatebox" style="width: 739px; height: 80px;resize:none;"  data-options="validType:'length[0,200]'"></textarea>
					</td>
				</tr>
				<tr>
