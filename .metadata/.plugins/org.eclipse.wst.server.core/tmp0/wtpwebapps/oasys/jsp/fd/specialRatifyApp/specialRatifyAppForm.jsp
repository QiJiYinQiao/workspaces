   ...
   <style>
    ...
    <legend><img src="extend/fromedit.png" style="margin-bottom: -3px;"/>基本信息</legend>
          ...
          <table  id="startIn" class="table">
             <tr>
                <th>贷款合同编号:</th>
                <td><input id="contractNo" name="contractNo" class="easyui-textbox easyui-validatebox" required="required" maxlength="50"/></td>
             </tr>
             <tr>
                <th>特批类型:</th>
                <td><input id="speRatType" name="speRatType" class="easyui-textbox easyui-validatebox"  editable="false"/></td>
                <th id="hiddenOne" class="dis">申请还款日期:</th>
                <td id="hiddenTwo" class="dis"><input id="appRepaymentDate" name="appRepaymentDate" class="easyui-datebox" editable="false"/></td>
             </tr>
		     <tr>
