...
<style type="text/css">
			...
			$(function() {
				...
				$grid =$("#dg").datagrid({
					...
					columns : [ [
					        ...
					        {field : 'fullName',title : '申请部门',width: 250,align : 'center'},
							...
							{field : 'turnoverDtime',title : '移交时间',width: 100,align : 'center'},   
							{field : 'useBgDate',title : '用章开始时间',width: 100,align : 'center',
								formatter : function(value, row, index) {
									if(value!=null){
										return value.split(" ")[0];
									}else{
							...
							{field : 'useEdDate',title : '用章结束时间',width: 100,align : 'center',
									formatter : function(value, row, index) {
										if(value!=null){
											return value.split(" ")[0];
										}else{
							...
							{field : 'useNature',title : '使用性质',width: 100,align : 'center',
										formatter : function(value, row, index) {
											if(value=='1'){
												return '本地使用';
											}else{
							...
							{field : 'stampType',title : '用章类型',width : 100,sortable : true,align : 'center'},
							{field : 'stampName',title : '印章名称',width: 170, sortable : true,align : 'center'},
  ...
  <body>
      <div id="task" class="position" style="margin-top: 5px;">您当前所在位置：用章申请  &gt; 代办任务</div>
		<!-- 高级查询栏区域 -->
