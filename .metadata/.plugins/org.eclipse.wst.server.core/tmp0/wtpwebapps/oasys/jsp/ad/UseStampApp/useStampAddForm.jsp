    ...
    function useStampGrid(appNo){
    	...
    	$("#useStampAtt").datagrid({
    		...
    		onLoadSuccess:function(data){
    			if(data.count>0 && $("#procStatusApp").val()!='1'){
    				$("#useStampForm input[type='radio']").attr("disabled",true);
    			}else{
    				$("#useStampForm input[type='radio']").attr("disabled",false);
    			}
    			//合并单元格
				  var rows = data.rows;
	        	  //合并部门
	         ...
	         <table class="table">
				...
				<tr>
				 ...
				 <tr>
					<th>备注信息:</th>
					<td colspan="3">
					  <textarea id="remark" name="remark" class="easyui-textbox easyui-validatebox" style="width: 810px; height: 80px;resize:none;" data-options="validType:'length[0,200]'"></textarea>
					</td>
				</tr>
				<tr>
