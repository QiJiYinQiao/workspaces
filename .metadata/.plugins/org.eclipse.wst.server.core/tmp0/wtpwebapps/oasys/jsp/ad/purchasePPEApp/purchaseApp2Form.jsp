<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <table class="table" style="width: 100%">
       ...
       <tr>
	      ...
	      <td>
	          <textarea name="remark" rows="5" cols="20" class="easyui-textbox easyui-validatebox" data-options="validType:'length[0,200]'" style="width: 720px;height: 50px;resize:none;"></textarea>
	      </td>
       </tr>
       <tr>
...
function toFormWindow(){
	...
	$sonDialog = $("<div></div>").dialog({
		    ...
		    closed: false,    
		    cache: false,    
		    href: 'jsp/ad/purchasePPEApp/purchaseAppAttachForm.jsp',    
		    modal: true,
		    onClose:function(){
		    	$(this).dialog('destroy');
		    },
		    buttons:[{
		    	...
		    	iconCls:'icon-save',
				handler:function(){
					savePurchaseAppAttach(false);
				}
		    },{
		    	text:'保存并关闭',
		    	iconCls:'icon-save',
				handler:function(){
					savePurchaseAppAttach(true);
				}
		    },{
		    	text:'关闭页面',
		    	iconCls:'icon-no',
 ...
 * 保存固定资产采购明细
 */
function savePurchaseAppAttach(type){
