	     ...
	     <form id="ppeUsedConfirmAtt" >
	         ...
	         <table class="table">
				 <tr>
				 	...
				 	<th>固定资产名称：</th>
				 	<td>
				 		<input name="ppeName" id="ppeName" type="text" class="easyui-textbox  easyui-validatebox" readonly="readonly" style="width: 170px"  data-options="required:true"/>
				 	</td>
				 </tr>
				 ...
				 <tr>
					<th>使用用途:</th>
					<td colspan="3">
					  <textarea id="usedReson" name="usedReson" class="easyui-textbox easyui-validatebox" style="width: 500px; height: 60px;resize:none;" data-options="required:true,validType:'length[1,200]'"></textarea>
					</td>
				</tr>
				 <tr>
					<th>备注信息:</th>
					<td colspan="3">
					  <textarea id="remarkAtt" name="remark" class="easyui-textbox easyui-validatebox" style="width: 500px; height: 60px;resize:none;" data-options="validType:'length[0,200]'"></textarea>
					</td>
				</tr>
