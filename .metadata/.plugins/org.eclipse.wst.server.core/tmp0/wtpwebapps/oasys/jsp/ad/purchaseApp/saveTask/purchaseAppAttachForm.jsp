	    ...
	    <fieldset>
		    ...
		    <table class="table">
		       ...
		       <tr>
		          ...
		          <td><input id="qty" name="qty" class="easyui-textbox easyui-validatebox easyui-numberbox" data-options="required:true,max:999,min:0,missingMessage:'数量范围为0-999'" onkeyup="sumPrice();"/></td>
		       </tr>
		       <tr>
		       ...
		       <tr>
		          ...
		          <td colspan="3"><textarea name="purpose" rows="5" cols="20" class="easyui-textbox easyui-validatebox" data-options="validType:'length[0,200]'" style="width: 450px;height: 70px;resize:none;"></textarea></td>
		       </tr>
		       <tr>
