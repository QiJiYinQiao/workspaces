	    ...
	    <input id="giveuseNature" name="useNature" type="hidden"><!-- 使用性质 -->
 		<table class="table"  width="95%">
				...
				<tr>
					...
					<td>
						<input name="emsNo" id="emsNo"    type="text" class="easyui-textbox easyui-validatebox"  style="width: 170px" data-options="required:true,editable:false,validType:'length[1,50]'"/>
					</td>
				...
				<tr>
					...
					<td>
						<input name="postAddr" id="postAddr" type="text" class="easyui-textbox easyui-validatebox" style="width: 350px" data-options="required:true,editable:false,validType:'length[1,256]'"/>
					</td>
