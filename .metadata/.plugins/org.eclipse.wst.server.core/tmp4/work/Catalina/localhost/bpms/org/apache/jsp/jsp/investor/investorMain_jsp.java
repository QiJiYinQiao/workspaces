 ...
 * Generated at: 2016-02-22 05:31:34 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\tcolumns : [ [ {field : 'chName',title : '客户姓名', width : parseInt($(this).width() * 0.05) ,align : 'center'},\r\n");
      out.write("\t\t\t\t\t              {field : 'idType',title : '证件类型', width : parseInt($(this).width() * 0.05) ,align : 'center',formatter:function(value, row, index){\r\n");
      out.write("\t\t\t\t\t\t\t\t        return jqueryUtil.showText(value,idtypeArr);\r\n");
      out.write("\t\t\t\t\t\t\t         }  \r\n");
      out.write("\t\t                          },\r\n");
      out.write("\t\t                          {field : 'idNo',title : '证件号码', width : parseInt($(this).width() * 0.09) ,align : 'center'},\r\n");
      out.write("\t\t\t\t\t              {field : 'genderType',title : '性别', width : parseInt($(this).width() * 0.04) ,align : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\tformatter:function(value, row, index){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\treturn jqueryUtil.showText(value,sexArr);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t  },\r\n");
      out.write("\t\t\t\t\t              {field : 'mobileTel',title : '移动电话', width : parseInt($(this).width() * 0.07) ,align : 'center'},\r\n");
      out.write("\t\t\t\t\t              {field : 'industry',title : '所属行业', width : parseInt($(this).width() * 0.05) ,align : 'center'},\r\n");
      out.write("\t\t\t\t\t              {field : 'jobType',title : '职业', width : parseInt($(this).width() * 0.06) ,align : 'center',\r\n");
      out.write("\t\t\t\t\t            \t  formatter:function(value, row, index){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\treturn jqueryUtil.showText(value,jobtypeArr);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  }  \r\n");
      out.write("\t\t\t\t\t              },\r\n");
      out.write("\t\t\t\t\t              {field : 'yearsOfWork',title : '工作年限', width : parseInt($(this).width() * 0.05) ,align : 'center'},\r\n");
      out.write("\t\t\t\t\t              {field : 'degreeType',title : '学历', width : parseInt($(this).width() * 0.05) ,align : 'center',formatter:function(value, row, index){\r\n");
      out.write("\t\t\t\t\t            \t  return jqueryUtil.showText(value,degreeTypeArr);\r\n");
      out.write("\t\t\t\t\t              }},\r\n");
      out.write("\t\t\t\t\t              {field : 'birthday',title : '出生日期', width : parseInt($(this).width() * 0.07) ,align : 'center'},\r\n");
      out.write("\t\t\t\t\t              {field : 'email',title : '邮箱', width : parseInt($(this).width() * 0.09) ,align : 'center'},\r\n");
      out.write("\t\t\t\t\t              {field : 'companyName',title : '单位名称', width : parseInt($(this).width() * 0.1) ,align : 'center'}\r\n");
      ...
      out.write("  </head>\r\n");
      out.write("  <style>\r\n");
      out.write("  .nkframe_position{padding-left:30px;margin-bottom:10px;border-bottom:1px solid #d2e7f8;height:24px;line-height:24px;background:url(extend/nk_position.gif) 5px center no-repeat;font-size:12px;font-weight:normal;}\r\n");
      out.write("  </style>\r\n");
      out.write("  <body>\r\n");
      out.write("      <div data-options=\"region:'center',border : false\">\r\n");
      out.write("     <div class=\"position\" style=\"margin-top: 5px;\">您当前所在位置： 业务管理  &gt; 财富业务管理  &gt; 客户管理 </div>\r\n");
