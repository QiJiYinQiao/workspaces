 ...
 * Generated at: 2015-08-14 02:33:31 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t/* row = this.getRowData(index);//获取本条数据\r\n");
      ...
      out.write("\t\t\tvar row = this.getRowData(index);\t\t\t\r\n");
      out.write("\t\t\t/* console.info(\"办理任务， row.taskId = \"+row.taskId) */\r\n");
      out.write("\t\t\tparent.$.modalDialog.openner= $grid;\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\ttype : \"POST\",\r\n");
      ...
      out.write("\t\t\t\t\tconsole.info(jspName);\r\n");
      out.write("\t\t\t\t\tparent.$.modalDialog({\r\n");
      ...
      out.write("\t\t\t\t<b>业务管理-->投资业务管理-->受理任务</b>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<!-- 高级查询栏区域 -->\r\n");
