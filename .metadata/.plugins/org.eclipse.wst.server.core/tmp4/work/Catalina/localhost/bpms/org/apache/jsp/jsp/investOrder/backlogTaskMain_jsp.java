 ...
 * Generated at: 2015-08-25 05:20:05 UTC
...
public final class backlogTaskMain_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\turl:'investOrder/investOrderAction!findAllTaskList.action',\r\n");
      out.write("\t\ttitle:'待办任务',\r\n");
      out.write("\t\twidth: 'auto',\r\n");
      out.write("\t\theight: $(this).height()-67,\r\n");
      ...
      out.write("\t\tcolumns:[[\r\n");
      out.write("\t\t        {field : 'investorName',title : '客户姓名',width :100,align : 'center',formatter:function(value,row,index){\r\n");
      out.write("\t\t        \treturn \"<a href=\\\"javascript:void(0)\\\" onclick=\\\"showInvestorView(\"+index+\")\\\">\"+value+\"</a>\";\r\n");
      out.write("\t\t        }},\r\n");
      out.write("                {field : 'idCrad',title : '证件号码',width : 180,align : 'center'},\r\n");
      out.write("\t            {field : 'mobTel',title : '手机号码',width : 150,align : 'center'},\r\n");
      out.write("\t            {field : 'licaichanping',title : '理财产品',width :150,align : 'center',formatter:function(value,row,index){\r\n");
      ...
      out.write("                }},\r\n");
      out.write("                {field : 'financingMgr',title : '理财经理',width : 100,align : 'center'},\r\n");
      out.write("                {field : 'fmPhone',title : '理财经理电话',width : 150,align : 'center'},\r\n");
      out.write("                {field : 'bankName',title : '开户行名称',width : 100,align : 'center'},\r\n");
      out.write("                {field : 'actNo',title : '开户行账号',width : 100,align : 'center'},\r\n");
      out.write("                {field : 'actName',title : '账户名称',width :100,align : 'center'},\r\n");
      out.write("                {field : 'fmSignDate',title : '理财经理签署日期',width :150,align : 'center'},\r\n");
      out.write("                {field : 'deptMgr',title : '部门主管',width :100,align : 'center'},\r\n");
      out.write("                {field : 'caozuo',title : '操作',width :220,align : 'center',formatter:function(value,row,index){\r\n");
      out.write("                \treturn \"<a href=\\\"javascript:void(0)\\\" onclick=\\\"checkInvestOrderOpinions(\"+index+\")\\\">查看审批意见</a>&nbsp;&nbsp;&nbsp;\"+\"<a href=\\\"javascript:void(0)\\\" onclick=\\\"checkProcessImg(\"+index+\")\\\">查看流程图</a>&nbsp;&nbsp;&nbsp;\"+\"<a href=\\\"javascript:void(0)\\\" onclick=\\\"claimTask(\"+index+\")\\\">签收任务</a>\";\r\n");
      out.write("                }}\r\n");
      out.write("\t   ]]\r\n");
      out.write("\t});\r\n");
      out.write("}\r\n");
      ...
      out.write("\t$.ajax({\r\n");
      out.write("\t\ttype:'POST',\r\n");
      out.write("\t\turl:'investOrder/investOrderAction!saveMyTask.action',\r\n");
