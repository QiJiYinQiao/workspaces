 ...
 * Generated at: 2015-11-12 03:27:22 UTC
...
public final class loanOrderAddForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t \t//$('#linkPeople').datagrid('options').url = \"contacts/contactsAction!findAllList.action\";// 这是不勾选的url\r\n");
      out.write("\t\t\t            //$('#linkPeople').datagrid('reload',{\"loanerId\": $addRow.loanerId}); \r\n");
      out.write("\t\t\t\t\t \t$('#linkPeople').datagrid('options').url = \"contacts/contactsAction!findAllListChacked.action\";// 默认回现勾选的url\r\n");
      out.write("\t\t\t            $('#linkPeople').datagrid('reload',{\"loanerId\": $addRow.loanerId,\"loanOrderId\":$(\"#loanOrderId\").val()}); \r\n");
      out.write("\t\t\t\t\t}else if(2==index){\r\n");
      out.write("\t\t\t\t\t\tinitDatagrid();//工作单位列表\r\n");
      out.write("\t\t\t\t\t \t//$('#dwDatagrid').datagrid('options').url = \"company/companyAction!findListByLoanerId.action\";\r\n");
      out.write("\t\t\t\t\t\t//$('#dwDatagrid').datagrid('reload',{\"loanerId\": $addRow.loanerId}); \r\n");
      out.write("\t\t\t\t\t \t$('#dwDatagrid').datagrid('options').url = \"company/companyAction!findAllListChacked.action\";\r\n");
      out.write("\t\t\t\t\t\t$('#dwDatagrid').datagrid('reload',{\"loanerId\": $addRow.loanerId,\"loanOrderId\":$(\"#loanOrderId\").val()}); \r\n");
      out.write("\t\t\t\t\t}else if(4==index){\r\n");
      out.write("\t\t\t\t\t\tinitBankGrid();//开户行列表\r\n");
      out.write("\t\t\t\t\t \t//$('#bankGrid').datagrid('options').url = \"accountInfo/accountInfoAction!findListByLoanerId.action\";\r\n");
      out.write("\t\t\t\t\t\t//$('#bankGrid').datagrid('reload',{\"loanerId\": $addRow.loanerId}); \r\n");
      out.write("\t\t\t\t\t \t$('#bankGrid').datagrid('options').url = \"accountInfo/accountInfoAction!findAllListChacked.action\";\r\n");
      out.write("\t\t\t\t\t\t$('#bankGrid').datagrid('reload',{\"loanerId\": $addRow.loanerId,\"loanOrderId\":$(\"#loanOrderId\").val()}); \r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t  }\r\n");
      out.write("\t\t\t   }\r\n");
      out.write("\t\t });\r\n");
