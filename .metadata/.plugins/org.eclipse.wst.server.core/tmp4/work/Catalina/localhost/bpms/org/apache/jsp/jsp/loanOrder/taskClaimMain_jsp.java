 ...
 * Generated at: 2015-10-08 02:19:27 UTC
...
String roles = shiroUser.getJsonRoles();
      ...
      out.write("\t\t\t\t\theight : $(this).height()*0.95,\r\n");
      ...
      out.write("\t\t\t\t\tcolumns : [ [ {field : 'name',title : '客户姓名',width : parseInt($(this).width()*0.04)},\r\n");
      out.write("\t\t\t\t\t              {field : 'idNo',title : '身份证号',width : parseInt($(this).width()*0.08)},\r\n");
      out.write("\t\t\t\t\t              {field : 'age',title : '年龄',width : parseInt($(this).width()*0.02)},\r\n");
      ...
      out.write("\t\t\t\t\t              {field : 'loanPeriod',title : '申请贷款期限',width : parseInt($(this).width()*0.05)},\r\n");
      out.write("\t\t\t\t\t              {field : 'repayMethod',title : '还款方式',width : parseInt($(this).width()*0.05)},\r\n");
      out.write("\t\t\t\t\t              {field : 'purpose',title : '贷款用途',width : parseInt($(this).width()*0.12)},\r\n");
      out.write("\t\t\t\t\t              {field : 'orderStatus',title : '订单状态',width : parseInt($(this).width()*0.1),\r\n");
      out.write("\t\t\t\t\t            \t  formatter:function(value,row,index){\r\n");
      out.write("\t\t\t\t\t            \t\t  return value.statusName;\r\n");
      out.write("\t\t\t\t\t            \t  }\r\n");
      out.write("\t\t\t\t            \t  },\r\n");
      out.write("\t\t\t\t\t              {field : 'operate',title : '操作',width : parseInt($(this).width()*0.25),\r\n");
      out.write("\t\t\t\t\t            \t  formatter: function(value,row,index){\r\n");
      ...
      out.write("\t\t\t\turl : \"loanOrder/loanOrderAction!findRunTaskHandlePersons.action\",\r\n");
      out.write("\t\t\t\twidth : 'auto',\r\n");
