 ...
 * Generated at: 2016-02-22 05:32:53 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\turl : \"investRedeem/investRedeemAction!findAllClaimedTask.action\", \r\n");
      out.write("\t\t\t\t\twidth : 'auto',\r\n");
      ...
      out.write("\t\t\t\t\t            \t  }\t\t\t\t\t            \t  \t\t\t\t\t            \t  \r\n");
      out.write("\t\t\t\t\t              },\r\n");
      out.write("\t\t\t\t\t              {field : 'signDate',      title : '合同签署日期', width : parseInt($(this).width()*0.08), align:'center',\r\n");
      out.write("\t\t\t\t\t            \t  formatter: function(value, row, index){\r\n");
      ...
      out.write("\t\t\t\t\t            \t  formatter: function(value,row,index){\r\n");
      out.write("\t\t      \t\t\t\t\t\t\tvar result =\"<a href='javascript:void(0);' onclick='checkInvestOrderOpinions(\"+index+\");'>查看审批意见</a>　 \";\r\n");
      ...
      out.write("\t\tfunction getRowDataInShouLiMainJsp (index) {\r\n");
      ...
      out.write("\t\t\tvar row = getRowDataInShouLiMainJsp(index);\r\n");
      ...
      out.write("\t\t\tvar row = getRowDataInShouLiMainJsp(index);\r\n");
      out.write(" \t\t\trow4OpinionsDialog = row;\r\n");
      ...
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\ttype : \"POST\",\r\n");
      out.write("\t\t\t\turl : \"investRedeem/investRedeemAction!findTaskFormKeyByTaskId.action\",\r\n");
