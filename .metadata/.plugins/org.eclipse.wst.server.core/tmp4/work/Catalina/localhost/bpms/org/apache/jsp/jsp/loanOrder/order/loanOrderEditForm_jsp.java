 ...
 * Generated at: 2015-12-08 01:26:57 UTC
...
public final class loanOrderEditForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\tlinkPeopleDatagrid({\"loanerId\": $row.loanerId,\"loanOrderId\": $row.loanOrderId});//紧急联系人列表\r\n");
      out.write("\t\t\t }else if(2==index){\r\n");
      out.write("\t\t\t\tinitDatagrid({\"loanerId\": $row.loanerId,\"loanOrderId\": $row.loanOrderId});//工作单位列表\r\n");
      out.write("\t\t\t }else if(3==index){\r\n");
      out.write("\t\t\t\t loadLoanOrderInfo($row);//渲染订单的信息\r\n");
      out.write("\t\t\t }else if(4==index){\r\n");
      out.write("\t\t\t\tinitBankGrid({\"loanerId\": $row.loanerId,\"loanOrderId\": $row.loanOrderId});//开户行列表\r\n");
