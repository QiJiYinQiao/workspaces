 ...
 * Generated at: 2015-10-16 02:32:14 UTC
...
public final class taskIPCData2Form_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\r\n");
      out.write("\t//渲染贷审委的信息\r\n");
      out.write("\t$('#ipclrcUser01').combogrid({    \r\n");
      out.write("\t    panelWidth:450,    \r\n");
      out.write("\t    idField:'userId',    \r\n");
      out.write("\t    textField:'name',  \r\n");
      out.write("\t\tqueryParams: {\"loanOrderId\": $row.loanOrderId,\"roleCode\":\"IPCDaiShenWei1\"},\r\n");
      out.write("\t\turl : \"loanOrder/loanOrderAction!findCandidatePersons.action?t=\"+ new Date(),\r\n");
      out.write("\t\tcolumns : [ [ \r\n");
      ...
      out.write("\t\r\n");
      out.write("\t//渲染贷审委的信息\r\n");
      out.write("\t$('#ipclrcUser02').combogrid({    \r\n");
      out.write("\t    panelWidth:450,    \r\n");
      out.write("\t    idField:'userId',    \r\n");
      out.write("\t    textField:'name',  \r\n");
      out.write("\t\tqueryParams: {\"loanOrderId\": $row.loanOrderId,\"roleCode\":\"IPCDaiShenWei2\"},\r\n");
      out.write("\t\turl : \"loanOrder/loanOrderAction!findCandidatePersons.action?t=\"+ new Date(),\r\n");
      out.write("\t\tcolumns : [ [ \r\n");
      out.write("\t\t              {field : 'name',title : '用户名',width : 100,align : 'center'},\r\n");
      out.write("\t\t              {field : 'email',title : '邮箱',width : 150,align : 'center'},\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t//渲染贷审委的信息\r\n");
      out.write("\t$('#ipclrcUser03').combogrid({    \r\n");
      out.write("\t    panelWidth:450,    \r\n");
      out.write("\t    idField:'userId',    \r\n");
      out.write("\t    textField:'name',  \r\n");
      out.write("\t\tqueryParams: {\"loanOrderId\": $row.loanOrderId,\"roleCode\":\"IPCDaiShenWei3\"},\r\n");
      out.write("\t\turl : \"loanOrder/loanOrderAction!findCandidatePersons.action?t=\"+ new Date(),\r\n");
      out.write("\t\tcolumns : [ [ \r\n");
      out.write("\t\t              {field : 'name',title : '用户名',width : 100,align : 'center'},\r\n");
      out.write("\t\t              {field : 'email',title : '邮箱',width : 150,align : 'center'},\r\n");
      ...
      out.write("\t\t// 判断是否含有贷审委\r\n");
      out.write("\t\tif($(\"#ipclrcUser01\").combogrid(\"getValue\")==\"\"\r\n");
      out.write("\t\t\t\t||$(\"#ipclrcUser02\").combogrid(\"getValue\")==\"\"\r\n");
      out.write("\t\t\t\t||$(\"#ipclrcUser03\").combogrid(\"getValue\")==\"\"){\r\n");
      out.write("\t\t\t$.messager.alert(\"提示\",\"请指定贷审委人员!\",\"warning\")\r\n");
      ...
      out.write("\t\t\t\t\t\"ipclrcUser01\":$(\"#ipclrcUser01\").combogrid(\"getValue\"),\r\n");
      out.write("\t\t\t\t\t\"ipclrcUser02\":$(\"#ipclrcUser02\").combogrid(\"getValue\"),\r\n");
      out.write("\t\t\t\t\t\"ipclrcUser03\":$(\"#ipclrcUser03\").combogrid(\"getValue\")\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\ttype : \"POST\",\r\n");
      ...
      out.write("\t\twindow.open(\"jsp/loanOrder/IPC/ipcApplicationReportDetail.jsp?loanOrderId=\"+$row.loanOrderId+\"&loanerId=\"+$row.loanerId,\r\n");
      out.write("\t\t\t\t\"稽核信息详情\", 'height=650, width=1000, top=200, left=400, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no')\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//查看呈报意见表\r\n");
      out.write("\tfunction ipcMicrocreditOpinionDailog(){\r\n");
      out.write("\t\twindow.open(\"jsp/loanOrder/IPC/ipcMicrocreditOpinion.jsp?loanOrderId=\"+$row.loanOrderId+\"&loanerName=\"+$row.name+\"&loanerIdNo=\"+$row.idNo+\"&purpose=\"+$row.purpose,\r\n");
      out.write("\t\t\t\t\"呈报意见详情\", 'height=650, width=1000, top=200, left=400, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no')\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      out.write("<!-- 受理任务 S -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input id=\"ipclrcUser01\" name=\"ipclrcUsesr01 \" readonly=\"readonly\" type=\"text\"/></td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<th>贷审委2</th>\r\n");
      out.write("\t\t\t\t\t\t<td><input id=\"ipclrcUser02\" name=\"ipclrcUser02 \" readonly=\"readonly\" type=\"text\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<th>贷审委3</th>\r\n");
      out.write("\t\t\t\t\t\t<td><input id=\"ipclrcUser03\" name=\"ipclrcUser03\" readonly=\"readonly\" type=\"text\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t \t<th>备注</th>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"5\">\r\n");
      out.write("\t\t\t\t\t\t\t<textarea id=\"comment\" name=\"comment\" class=\"easyui-validatebox easyui-textbox\" style=\"width:100%;height:68px;resize:none;\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>\r\n");
      ...
      out.write("\t\t<a href=\"javascript:void(0);\" class=\"easyui-linkbutton\" onclick=\"ipcMicrocreditOpinionDailog();\">查看呈报意见</a>\r\n");
      out.write("\t\t<a href=\"javascript:void(0);\" class=\"easyui-linkbutton\" onclick=\"submitTask('IPCData2Through',this);\" >IPC审查员通过</a>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
