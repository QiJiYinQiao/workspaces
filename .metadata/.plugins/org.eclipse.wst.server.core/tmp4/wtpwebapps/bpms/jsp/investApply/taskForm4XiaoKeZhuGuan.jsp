...
/* 					url : "investOrder/investOrderAction!submitTask.action", */
	...
	//打开客户详情汇总页面
	function queryInvestorSummaryStatement() {
		window.open("jsp/investorReport/investorSummaryStatement.jsp","客户信息汇总",
				"height=800,width=1600,top=100,left=100,toolbar=no,menubar=no");
	}
</script>
		...
		<div data-options="region:'north',title:'North Title',split:true">
			...
			<div style="width: 880px;height:30px;">
				...
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="queryInvestorSummaryStatement()">查看/导出客户详情汇总</a>
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('XiaoKeZhuGuanTongGuo',this);">审批通过</a>
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('XiaoKeZhuGuanBoHui',this);">审批驳回</a>
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('XiaoKeZhuGuanJuJue',this);">审批拒绝</a>
			</div>
