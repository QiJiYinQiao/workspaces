...
function createMyTaskGrid(){
	$("#taskList").datagrid({
		url:'investOrder/investOrderAction!findAllTaskList.action',
		title:'待办任务',
		width: 'auto',
		...
		columns:[[
		        {field : 'investorName',title : '客户姓名',width :100,align : 'center',formatter:function(value,row,index){
	            ...
	            {field : 'licaichanping',title : '理财产品',width :150,align : 'center',formatter:function(value,row,index){
                ...
                {field : 'caozuo',title : '操作',width :220,align : 'center',formatter:function(value,row,index){
                	return "<a href=\"javascript:void(0)\" onclick=\"checkInvestOrderOpinions("+index+")\">查看审批意见</a>&nbsp;&nbsp;&nbsp;"+"<a href=\"javascript:void(0)\" onclick=\"checkProcessImg("+index+")\">查看流程图</a>&nbsp;&nbsp;&nbsp;"+"<a href=\"javascript:void(0)\" onclick=\"claimTask("+index+")\">签收任务</a>";
                }}
	   ]]
	});
}
...
function claimTask(index){
	...
	$.ajax({
		type:'POST',
		url:'investOrder/investOrderAction!saveMyTask.action',
