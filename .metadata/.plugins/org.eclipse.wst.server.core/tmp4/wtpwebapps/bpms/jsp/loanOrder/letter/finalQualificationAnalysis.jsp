		...
		<div title="资质分析">
			<form id="finalAuditReport-form" method="post">
				...
				<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
					...
					<tr>
						<th>合同金额:</th>
						<td><input id="contractLoanAmount" name="contractLoanAmount"  class="easyui-validatebox easyui-numberbox" data-options="min:0,max:9999999999,precision:2,required:true"  onblur="calculate();"/>元</td>
						<th>贷款期限:</th>
					...
					<tr>
						<th>实放金额:</th>
						<td><input id="actualLoanAmount" name="actualLoanAmount"  class="easyui-validatebox easyui-numberbox" data-options="disabled:true,min:0,precision:2,groupSeparator:','" />元</td>
						<th>月还款额:</th>
						<td><input id="monthRepay" name="monthRepay"  class="easyui-validatebox easyui-numberbox" data-options="disabled:true,min:0,precision:2,groupSeparator:','" /></td>
					</tr>
					<tr>
						<th>终审人:</th>
						<td>
					...
					<tr>
						<th>终审人员意见:</th>
						<td colspan="5"><textarea id="finaPersSugg" name="finaPersSugg" style="width:95%;height:70px;" class="easyui-validatebox easyui-textbox" data-options="required:true,validType:'length[0,1024]'"></textarea></td>
					</tr>
					<tr>
						<th>终审资质分析说明:</th>
						<td colspan="5"><textarea id="description" name="description" style="width:95%;height:70px;" class="easyui-validatebox easyui-textbox" data-options="required:true,validType:'length[0,1024]'"></textarea></td>
					</tr>
					<tr>
