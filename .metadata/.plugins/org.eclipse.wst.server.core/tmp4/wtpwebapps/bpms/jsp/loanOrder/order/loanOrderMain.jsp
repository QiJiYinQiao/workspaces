...
<script type="text/javascript">
	...
	$(function() {
		...
		$grid =$("#dg").datagrid({
					...
					multiSort:false,
 					columns : [ [
							{field : 'name',title : '客户姓名',width : parseInt($(this).width()*0.12),align : 'center',
								formatter : function(value, row, index) {
									return "<a href=\"javascript:void(0)\" onclick=\"showView("+ index + ");\">" + value + "</a>";
								}
							},
							{field : 'age',title : '年龄',width : parseInt($(this).width()*0.05),sortable : true,align : 'center'},
							{field : 'idNo',title : '身份证号',width : parseInt($(this).width()*0.12),align : 'center'},
							{field : 'mobileTel',title : '手机号码',width : parseInt($(this).width()*0.12),align : 'center'},
							{field : 'annualSalary',title : '年收入(元)',width : parseInt($(this).width()*0.12),align : 'center',
								formatter : function(value, row, index) {
									if (value != null) {
							...
							{field : 'incomeSrc',title : '收入来源',width : parseInt($(this).width()*0.12),align : 'center'},
							{field : 'loanAmount',title : '申请贷款额度(元)',width : parseInt($(this).width()*0.12),align : 'center',
								formatter : function(value, row, index) {
									if (value != null) {
										return "<font color=\"#9EE319\">" + value + "</font>";
									} 
							...
							{field : 'loanPeriod',title : '申请贷款期限(月)',width : parseInt($(this).width()*0.12),align : 'center'},
							{field : 'loanTypeName',title : '贷款类型',width : parseInt($(this).width()*0.12),align : 'center'},
				            {field : 'belongTo',title : '所属业务',width : parseInt($(this).width()*0.05)},
				            {field : 'loanInfo',title : '进件情况',width : parseInt($(this).width()*0.07),
				            	formatter:function(value,row,index){
				            		  if(value=="1"){
				            			  return "第一次申请";
				            		  }else if(value=="2"){
							...
							{field : 'repayMethodName',title : '还款方式',width : parseInt($(this).width()*0.12),align : 'center'},
							{field : 'status',title : '订单状态',width : parseInt($(this).width()*0.12),align : 'center',
								formatter : function(value, row, index) {
		...
		<div  style="margin-left: 5px; margin-top: 5px">
			...
			<form id="queryLoanOrderForm" method="post">
				<table cellpadding="6">
					<tr>
						<th>客户姓名</th>
						<td><input id="loanerName" name="loanerNname" class="easyui-textbox" style="width:134px;" ></td>
						
						<th>手机号</th>
						<td><input id="mobileTel" name="mobileTel" class="easyui-numberbox" style="width:134px;"></td>
						
						<th>身份证号</th>
						<td><input id="idNo" name="idNo" class="easyui-textbox" style="width:134px;"></td>
						
						<th>贷款类型</th>
						<td><input id="loanType" name="loanType" class="easyui-combobox" style="width:134px;"></td>
						<td align="right">
