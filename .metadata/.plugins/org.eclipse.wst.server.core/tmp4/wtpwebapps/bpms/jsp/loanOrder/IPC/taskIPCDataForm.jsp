...
<div data-options="region:'north',title:'North Title',split:true">
	...
	<div style="width:900px;height:30px;">
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('IPCDataThrough',this);" >IPC数据通过</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('IPCDataReject',this);" >IPC数据驳回</a>
	</div>
