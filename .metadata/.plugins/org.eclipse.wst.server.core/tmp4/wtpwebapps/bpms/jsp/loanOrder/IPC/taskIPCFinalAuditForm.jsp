...
<script type="text/javascript">
	...
	//填写终审报告
	function saveFinalAudit(result){
		$result = result;
	...
	function finalAuditRefuse(result){
		...
		applicationReportDialog = $("<div></div>").dialog({
			...
			href : "jsp/loanOrder/IPC/finalAuditAnalyRefuse.jsp"
		});
	}
...
<div data-options="region:'north',title:'North Title',split:true" style="overflow: hidden;">
	...
	<div style="width: 900px;height:30px;">
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="saveFinalAudit('IPCFinalAuditThrough');" >审核专员通过</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="finalAuditRefuse('IPCFinalAuditThrough');">审核专员拒贷</a>
