	...
	function  submitTask(result,object) {
		...
		$.messager.confirm('提示', '点击按钮之后将进入下一个任务活动环节,此任务将对您不可见!', function(r){
			if (r){
				...
				$.ajax({
					type : "POST",
					url : "investRedeem/investRedeemAction!reSubmitTask.action",
					data : data,
...
<div data-options="region:'north',title:'North Title',split:true">
	...
	<div style="width: 880px;height:30px;">		
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-redo" onclick="submitTask('InvestRedeemResubmit',this);">订单重提</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" onclick="submitTask('InvestRedeemRevoke',this);">订单撤销</a>								
	</div>
