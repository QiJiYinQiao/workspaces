 ...
 * Generated at: 2015-05-25 06:59:13 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.jsp.dbBackUp;
...
public final class dbBackUpMain_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\turl : \"dbBackUp/dbBackUpAction!findDbBackUpAllList.action\",\r\n");
      ...
      out.write("\t\t\t\t\tcolumns : [ [ {field : 'name',title : '操作用户',width : parseInt($(this).width()*0.1)},\r\n");
      out.write("\t\t\t\t\t              {field : 'ip',title : 'IP地址',width : parseInt($(this).width()*0.1)},\r\n");
      out.write("\t\t\t\t\t              {field : 'mac',title : '物理地址',width : parseInt($(this).width()*0.1)},\r\n");
      out.write("\t\t\t\t\t              {field : 'logDate',title : '备份日期',width : parseInt($(this).width()*0.1)},\r\n");
      out.write("\t\t\t\t\t              {field : 'type',title : '日志类型',width : parseInt($(this).width()*0.1),align : 'left',formatter:function(value,row){\r\n");
      out.write("\t\t\t\t            \t\t  if(\"1\"==row.type)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\treturn \"<font color=green>安全日志<font>\";\r\n");
      out.write("\t\t\t\t\t            \t\t  else\r\n");
      out.write("\t\t\t\t\t            \t\t\treturn \"<font color=red>操作日志<font>\";  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t}},\r\n");
      out.write("\t\t\t\t\t              {field : 'objectId',title : '备份文件名称',width :parseInt($(this).width()*0.3),align : 'left',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tformatter:function(value,row){\r\n");
      out.write("\t\t\t\t\t            \t  \treturn \"<a href='javascript:void(0);' id='backUpA' onclick='downBackUpFile(\\\"\"+row.objectId+\"\\\")'>\"+row.objectId+\"</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}}\r\n");
      ...
      out.write("\t\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\tfunction downBackUpFile(fileName){\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl:\"dbBackUp/dbBackUpAction!checkBackUp.action\",\r\n");
      out.write("\t\t\t\t\ttype:\"POST\",\r\n");
      out.write("\t\t\t\t\tdata:\"fileName=\"+fileName,\r\n");
      out.write("\t\t\t\t\tbeforeSend: function(){\r\n");
      out.write("\t\t\t\t\t\tparent.$.messager.progress({\r\n");
      out.write("\t\t\t\t\t\t\ttitle : '提示',\r\n");
      out.write("\t\t\t\t\t\t\ttext : '正在压缩数据，请稍后....'\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t},\r\n");
      ...
      out.print(basePath);
      out.write("dbBackUp/dbBackUpAction!downBackUpFile.action?fileName=\"+fileName;\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      ...
      out.write("\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\turl:\"logs/logsAction!delLogs.action\",\r\n");
      out.write("\t\t\t\t\t\tdata: \"logId=\"+row.logId,\r\n");
      ...
      out.write("\t\t\t\t\t\ttitle : '手动备份',\r\n");
      out.write("\t\t\t\t\t\twidth : 600,\r\n");
      out.write("\t\t\t\t\t\theight : 400,\r\n");
      out.write("\t\t\t\t\t\thref : \"jsp/dbBackUp/autoEditDlg.jsp\",\r\n");
      out.write("\t\t\t\t\t\tbuttons : [ {\r\n");
      out.write("\t\t\t\t\t\t\ttext : '备份',\r\n");
      out.write("\t\t\t\t\t\t\ticonCls : 'icon-start',\r\n");
      ...
      out.write("\t\t\t\tparent.$.modalDialog({\r\n");
      out.write("\t\t\t\t\ttitle : '定时备份',\r\n");
      out.write("\t\t\t\t\twidth : 600,\r\n");
      out.write("\t\t\t\t\theight : 400,\r\n");
      out.write("\t\t\t\t\thref : \"jsp/dbBackUp/timeEditDlg.jsp\",\r\n");
      out.write("\t\t\t\t\tonLoad:function(){\r\n");
      out.write("\t\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\turl:\"dbBackUp/dbBackUpAction!getScheduleConfig.action\",\r\n");
      out.write("\t\t\t\t\t\t\ttype:\"POST\",\r\n");
      out.write("\t\t\t\t\t\t\tsuccess:function(res){\r\n");
      out.write("\t\t\t\t\t\t\t\tvar f = parent.$.modalDialog.handler.find(\"#form\");\r\n");
      out.write("\t\t\t\t\t\t\t\tf.form(\"load\", res);\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t},\t\r\n");
      ...
      out.write("\t\t\t\t#backUpA {font-size:12px}   \r\n");
      out.write("\t\t\t\t#backUpA:link {color: blue; text-decoration:none;}   \r\n");
      out.write("\t\t\t\t#backUpA:active:{color: red; }   \r\n");
      out.write("\t\t\t\t#backUpA:visited {color:purple;text-decoration:none;}   \r\n");
      out.write("\t\t\t\t#backUpA:hover {color: red; text-decoration:underline;}   \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</style>\r\n");
      out.write("  </head>\r\n");
      out.write("  <body>\r\n");
      ...
      out.write("\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t在此你可以对数据进行<span class=\"label-info\"><strong>备份!有两种备份方式定时备份和手动备份，手动备份不影响定时备份！</strong></span>\r\n");
      out.write("\t\t\t\t</p>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"mm\">\r\n");
      out.write("\t\t\t\t<div name=\"name\">日志名称</div>\r\n");
      out.write("\t\t\t\t<div name=\"logDate\">创建日期</div>\r\n");
      out.write("\t\t\t\t<div name=\"type\">类型</div>\r\n");
      out.write("\t\t\t\t<div name=\"eventName\">操作名称</div>\r\n");
      out.write("\t\t\t\t<div name=\"eventRecord\">操作描述</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<table id=\"dg\" title=\"备份管理\"></table>\r\n");
      out.write("  \t</div>\t\r\n");
      out.write("  </body>\r\n");
      out.write("</html>\r\n");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/dbBackUp/dbBackUpMain.jsp(208,6) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f0.setName("dbBackUpHand");
    int _jspx_eval_shiro_005fhasPermission_005f0 = _jspx_th_shiro_005fhasPermission_005f0.doStartTag();
    if (_jspx_eval_shiro_005fhasPermission_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t<a href=\"javascript:void(0);\" class=\"easyui-linkbutton\" iconCls=\"icon-time\" plain=\"true\" onclick=\"addRowsOpenDlg();\">定时备份</a>\r\n");
        out.write("\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/dbBackUp/dbBackUpMain.jsp(211,6) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f1.setName("dbBackUpTime");
    ...
    if (_jspx_eval_shiro_005fhasPermission_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t<a href=\"javascript:void(0);\" class=\"easyui-linkbutton\" iconCls=\"icon-auto\" plain=\"true\" onclick=\"updRowsOpenDlg();\">手动备份</a>\r\n");
        out.write("\t\t\t\t\t\t");
