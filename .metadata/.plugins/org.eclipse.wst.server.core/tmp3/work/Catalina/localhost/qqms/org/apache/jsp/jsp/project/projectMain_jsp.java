 ...
 * Generated at: 2015-05-25 06:58:51 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\turl : \"project/projectAction!findProjectList.action\",\r\n");
      ...
      out.write("\t\t\t\t\tcolumns : [ [ {field : 'name',title : '项目名称',width : parseInt($(this).width()*0.1)},\r\n");
      out.write("\t\t\t\t\t              {field : 'myid',title : '项目编码',width : parseInt($(this).width()*0.1)},\r\n");
      out.write("\t\t\t\t\t              {field : 'setupDate',title : '立项日期',width : parseInt($(this).width()*0.05)},\r\n");
      out.write("\t\t\t\t\t              {field : 'className',title : '项目类型',width : parseInt($(this).width()*0.1)},\r\n");
      out.write("\t\t\t\t\t              {field : 'customerMyid',title : '客户名称',width : parseInt($(this).width()*0.05),align : 'left'},\r\n");
      out.write("\t\t\t\t\t              {field : 'contacts',title : '联系人',width : parseInt($(this).width()*0.05),align : 'left'},\r\n");
      out.write("\t\t\t\t\t              {field : 'startTime',title : '开始时间',width : parseInt($(this).width()*0.1),align : 'left'},\r\n");
      out.write("\t\t\t\t\t              {field : 'endTime',title : '结束时间',width :parseInt($(this).width()*0.1),align : 'left'},\r\n");
      out.write("\t\t\t\t\t              {field : 'managerName',title : '项目负责人',width : parseInt($(this).width()*0.05),align : 'left'},\r\n");
      ...
      out.write("\t\t\t\t\t    \t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\t\turl:\"project/projectAction!delProject.action\",\r\n");
      out.write("\t\t\t\t\t\t\t\tdata: \"projectId=\"+row.projectId,\r\n");
      ...
      out.write("\t\t\t\t\t\ttitle : '编辑项目',\r\n");
      out.write("\t\t\t\t\t\twidth : 900,\r\n");
      out.write("\t\t\t\t\t\theight :550,\r\n");
      out.write("\t\t\t\t\t\thref : \"jsp/project/projectEditDlg.jsp?tempId=\"+row.projectId,\r\n");
      out.write("\t\t\t\t\t\tonLoad:function(){\r\n");
      out.write("\t\t\t\t\t\t\trow.managerId=(typeof(row.managerId)==\"undefined\")?row.managerId:\"0\"+row.managerId;\r\n");
      ...
      out.write("\t\t\t\tparent.$.modalDialog({\r\n");
      out.write("\t\t\t\t\ttitle : '添加项目',\r\n");
      out.write("\t\t\t\t\twidth : 900,\r\n");
      out.write("\t\t\t\t\theight :550,\r\n");
      out.write("\t\t\t\t\thref : \"jsp/project/projectEditDlg.jsp\",\r\n");
      out.write("\t\t\t\t\tbuttons : [ {\r\n");
      out.write("\t\t\t\t\t\ttext : '保存',\r\n");
      out.write("\t\t\t\t\t\ticonCls : 'icon-ok',\r\n");
      out.write("\t\t\t\t\t\thandler : function() {\r\n");
      ...
      out.write("\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t在此你可以对<span class=\"label-info\"><strong>项目</strong></span>进行编辑!\r\n");
      out.write("\t\t\t\t</p>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"mm\">\r\n");
      out.write("\t\t\t\t<div name=\"name\">项目名称</div>\r\n");
      out.write("\t\t\t\t<div name=\"myid\">项目编码</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<table id=\"dg\" title=\"项目管理\"></table>\r\n");
      out.write("  \t</div>\t\r\n");
      out.write("  </body>\r\n");
      out.write("</html>\r\n");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/project/projectMain.jsp(176,6) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/project/projectMain.jsp(179,6) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/project/projectMain.jsp(182,6) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
