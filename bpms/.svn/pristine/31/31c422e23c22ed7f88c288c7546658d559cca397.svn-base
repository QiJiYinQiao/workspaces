			...
			<form id="finalAuditReport-form" method="post">
				...
				<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
					...
					<tr>
						...
						<th>月服务汇率:</th>
						<td><input id="monthServiceFeeRate" name="monthServiceFeeRate" onchange="calculate();"/></td>
					</tr>
					<tr>
						<th>利息:</th>
					...
					<tr>
						<th>审贷部门意见:</th>
						<td colspan="6"><textarea id="finaPersSugg" name="finaPersSugg" style="width:95%;height:70px;" class="easyui-validatebox easyui-textbox" data-options="required:true,validType:'length[0,1024]'"></textarea></td>
					</tr>
					<tr>
