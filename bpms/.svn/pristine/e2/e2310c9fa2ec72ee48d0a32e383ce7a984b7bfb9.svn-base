...
<!-- 	<div style="height: 280px;overflow: auto;" > -->
	...
	<div style="width: 880px;height:30px;">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('ZongJingLiTongGuo',this);">审批通过</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('ZongJingLiJianBoHui',this);">审批驳回</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('ZongJingLiJuJue',this);">审批拒绝</a>
	</div>
