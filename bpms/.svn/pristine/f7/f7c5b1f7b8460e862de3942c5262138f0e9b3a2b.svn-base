...
function createLoanOrderGrid(){
	$("#loanOrderGrid").datagrid({
		...
		columns:[[
              ...
              {field : 'idNo',title : '身份证号',width:180,align:'center'},
              {field : 'age',title : '年龄',width:80,align:'center'},
              {field : 'annualSalary',title : '年收入(单位:万)',width:120,align:'center'},
              {field : 'mortgageStatus',title : '居住情况',width:150,align:'center',formatter:function(value,row,index){
            	  return jqueryUtil.showText(value,mortgageStatusArr);
              }},
              {field : 'loanAmount',title : '申请贷款额度(单位:万)',width:150,align:'center'},
              {field : 'loanMin',title : '最低接受额度(单位:万)',width : 150,align:'center'},
              {field : 'loanPeriod',title : '申请贷款期限(月)',width:150,align:'center'},
              {field : 'repayMethod',title : '还款方式',width:150,align:'center',formatter:function(value,row,index){
            	  return jqueryUtil.showText(value,repayMethodArr);
              }},
              {field : 'purpose',title : '贷款用途',width:250,align:'center'},
              {field : 'caozuo',title : '操作',width:150,align:'center',formatter:function(value,row,index){
