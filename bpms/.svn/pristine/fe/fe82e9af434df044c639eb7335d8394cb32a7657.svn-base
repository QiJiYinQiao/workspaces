		...
		<div title="资质分析">
			<form id="finalAuditReport-form" method="post">
				...
				<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
					...
					<tr>
						<th>合同金额:</th>
						<td><input name="contractLoanAmount" class="easyui-numberbox" value="0" data-options="groupSeparator:','" readonly="readonly"/>元</td>
						<th>贷款期限:</th>
					...
					<tr>
						...
						<th>信访费用:</th>
						<td ><input name="visitFee"  class="easyui-validatebox easyui-numberbox" value="0" readonly="readonly" />元</td>
						<th>信贷方式:</th>
						<td>
					...
					<tr>
						<th>实放金额:</th>
						<td><input name="actualLoanAmount"  class="easyui-numberbox" value="0" data-options="groupSeparator:','" readonly="readonly" />元</td>
						<th>月还款额:</th>
						<td><input name="monthRepay"  class="easyui-numberbox" value="0" data-options="groupSeparator:','" readonly="readonly" /></td>
						<th>初审建议金额</th>
						<td><input id="firstAuditSugAmt" class="easyui-numberbox" data-options="groupSeparator:','" disabled="disabled"></td>
					</tr>
					<tr>
						<th>审核专员:</th>
						<td>
