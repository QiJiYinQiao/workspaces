...
/* 					url : "investOrder/investOrderAction!submitTask.action", */
	...
	// 导出收款确认书
	function downloadPayConfirmation() {
		downFileByFormPost("investorRelativeTabsExport/investorRelativeTabsExportAciton!downloadPayConfirmation.action", 
				{"investOrderId":investOrderId}
		);
	}
</script>
		...
		<div data-options="region:'north',title:'North Title',split:true">
			...
			<div style="width: 880px;height:30px;">
				...
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="downloadPayConfirmation()">导出收款确认书</a>
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('ShuJuZhuanYuanTongGuo',this);">审批通过</a>
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('ShuJuZhuanYuanBoHui',this);">审批驳回</a>
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('ShuJuZhuanYuanJuJue',this);">审批拒绝</a>
			</div>
