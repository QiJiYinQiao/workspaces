...
/* 					url : "investOrder/investOrderAction!submitTask.action", */
	...
	//导出电子账单
	function downloadElectronicBill() {
		downFileByFormPost("investorRelativeTabsExport/investorRelativeTabsExportAciton!downloadElectronicBill.action", 
				{"investOrderId":investOrderId}
		);
	}
</script>
		...
		<div data-options="region:'north',title:'North Title',split:true">
			...
			<div style="width: 880px;height:30px;">
				...
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="downloadElectronicBill()">导出电子账单</a>
				<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('XiaoKeZhuanYuanTongGuo',this);">审批通过</a>
