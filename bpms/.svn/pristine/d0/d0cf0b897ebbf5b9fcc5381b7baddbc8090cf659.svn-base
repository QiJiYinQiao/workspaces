...
<script type="text/javascript">
	...
	$(function(){
		...
		row["addrDetails"]=row.addressDetails;
		//加载投资人信息
		$("#baseInfoForm").form("load",row);
		...
		$.messager.confirm('提示', '点击按钮之后将进入下一个任务活动环节,此任务将对您不可见!', function(r){
			if (r){
				var data = {
					...
					"taskId": taskId,
					"processingResult":result=="OrderResubmitted"?"A":"B"
				}
				$.ajax({
					type : "POST",
	    ...
	    <form id="baseInfoForm">
          ...
          <table>
             <tr>
                ...
                <th>性别:</th>
                <td><input name="genderType" class="easyui-combobox" panelHeight="auto" editable="false"/></td>
             </tr>
             <tr>
                <th>出生日期:</th>
                ...
                <th>婚姻状况:</th>
                <td><input name="maritalStatus" class="easyui-combobox" panelHeight="auto" editable="false"/></td>
             </tr>
             <tr>
                <th>证件类型:</th>
                <td><input name="idType" class="easyui-combobox" panelHeight="auto" editable="false"/></td>
                <th>证件号码:</th>
                <td><input name="idNo" class="easyui-textbox easyui-validatebox" data-options="validType:'idcard'"/></td>
                <th>签发日期:</th>
                <td><input name="idIssueDate"  class="easyui-datebox" editable="false"/></td>
             </tr>
             <tr>
                <th>失效日期:</th>
                <td><input name="idExpireDate" class="easyui-datebox" editable="false"/></td>
                <th>发证机构所在地:</th>
                <td><input name="idLocation" class="easyui-textbox easyui-validatebox" data-options="validType:'length[0,127]'"/></td>
                <th>学历:</th>
                <td><input name="degreeType" class="easyui-combobox" panelHeight="auto" editable="false"/></td>
             </tr>
             <tr>
                <th>职业:</th>
                <td><input name="jobType" class="easyui-combobox" panelHeight="auto" editable="false"/></td>
                <th>行业:</th>
             ...
             <tr>
                ...
                <th>单位规模:</th>
                <td><input name="compScale" class="easyui-combobox" panelHeight="auto" editable="false"/></td>
                <th>职务:</th>
             ...
             <tr>
                ...
                <th>家庭情况:</th>
                <td><input name="familyStatus" class="easyui-combobox" panelHeight="auto" editable="false"/></td>
                <th>家庭收入情况:</th>
                <td><input name="famIncSta" class="easyui-combobox" panelHeight="auto" editable="false"/></td>
             </tr>
             <tr>
                <th>通讯地址:</th>
                <td colspan="5">
			           ...
			           区/县:<input id="areaId" name="areaId" type="text" class="easyui-combobox" style="width: 100px;"/> 
			              街道:<input name="addrDetails" class="easyui-textbox easyui-validatebox" data-options="validType:'length[0,250]'" style="width: 340px;"/>     
                </td>
             </tr>
             <tr>
                <th>客户类型:</th>
        ...
        <!-- <input name="annualSalary" type="hidden"/> 年收入 -->
         ...
         <table class="table">
           <tr>
             ...
             <th>性别:</th>
             <td><input name="genderType" panelHeight="auto" editable="false"/></td>
           </tr>
           <tr>
             <th>出生日期:</th>
             <td><input name="birthday" class="easyui-datebox" editable="false"/></td>
             <th>证件类型:</th>
             <td><input name="idType" panelHeight="auto" editable="false"/></td>
             <th>证件号码:</th>
             <td><input name="idNo" class="easyui-textbox easyui-validatebox" data-options="validType:'idcard'"/></td>
           </tr>
           <tr>
           ...
           <tr>
             <th>与您的关系:</th>
             <td><input name="relationship" panelHeight="auto" editable="false"/></td>
             <th>邮编:</th>
             <td><input name="zip" class="easyui-textbox easyui-validatebox" data-options="validType:'zip'"/></td>
           </tr>
           <tr>
...
<div id="tt_1" align="right">
	<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-redo" onclick="submitTask('OrderResubmitted',this);">订单重提</a>
	<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" onclick="submitTask('OrderRevoke',this);">订单撤销</a>
</div>