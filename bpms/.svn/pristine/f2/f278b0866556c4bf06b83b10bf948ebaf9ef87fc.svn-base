	...
	function getAccountsJournalForm(type,index,month){
		...
		var accountsJournalFormStr= 
			...
			+"	<a  href='javascript:void(0);' class='easyui-linkbutton' iconCls='icon-remove' plain='true'  href='javascript:void(0);'  onclick='removeAccountsJournalForm(this);'>删除</a>"
		  	...
		  	+"			<tr>"
		  	+"			<th>[入账金额:元]</th>"
		  	+"			<td><input name='income01' style='width: 100px;' class='easyui-validatebox easyui-numberbox' data-options=\"min:0,max:999999999999,precision:2,groupSeparator:','\"/></td>"
		  	+"			<td><input name='income02' style='width: 100px;' class='easyui-validatebox easyui-numberbox' data-options=\"min:0,max:999999999999,precision:2,groupSeparator:','\"/></td>"
		  	+"			<td><input name='income03' style='width: 100px;' class='easyui-validatebox easyui-numberbox' data-options=\"min:0,max:999999999999,precision:2,groupSeparator:','\"/></td>"
		  	+"			<td><input name='income04' style='width: 100px;' class='easyui-validatebox easyui-numberbox' data-options=\"min:0,max:999999999999,precision:2,groupSeparator:','\"/></td>"
		  	+"			<td><input name='income05' style='width: 100px;' class='easyui-validatebox easyui-numberbox' data-options=\"min:0,max:999999999999,precision:2,groupSeparator:','\"/></td>"
		  	+"			<td><input name='income06' style='width: 100px;' class='easyui-validatebox easyui-numberbox' data-options=\"min:0,max:999999999999,precision:2,groupSeparator:','\"/></td>"
		  	+"		</tr>"
		  	+"		<tr>"
		  	+"			<th>月均:</th>"
		  	+"			<td><input name='averageIncome' style='width: 100px;' class='easyui-validtebox easyui-numberbox' data-options=\"min:0,max:999999999999,precision:2,required:true,groupSeparator:','\"/>元</td>"
		  	+"		</tr>"
		  	+"		<tr>"
		  	+"			<th>流水分析:</th>"
	...
	<div title="客户基本信息">
		<form id="loanerCARInfo-form" style="height:570px;">
			<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
				...
				<tr>
					<th>申贷金额:</th>
					<td><input  name="loanAmount" class="easyui-numberbox easyui-validatebox" data-options="min:0,precision:2,groupSeparator:','" disabled="disabled"/>元</td>
					<th>贷款用途:</th>
	...
	<div title="征信情况">
		...
		<form id="loansDetails-form" method="post">
			...
			<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
				...
				<tr>
					...
					<th>未结清贷款总额:</th>
					<td><input name="outstandingSum" class="easyui-validatebox easyui-numberbox" data-options="min:0,max:999999999999,precision:2,required:true,groupSeparator:','"/>元</td>
				</tr>
				<tr>
					<th>未结清笔数:</th>
					...
					<th>未结清贷款余额:</th>
					<td><input name="outstandingBalance" class="easyui-validatebox easyui-numberbox" data-options="min:0,max:999999999999,precision:2,required:true,groupSeparator:','"/>元	</td>
				</tr>
				<tr>
					<th>逾期率:</th>
					<td><input name="overdueRate"  class="easyui-validatebox easyui-textbox" data-options="validType:'length[0,5]',required:true"/></td>
					<th>月还额度:</th>
					<td><input name="monthRepay"  class="easyui-validatebox easyui-numberbox" data-options="min:0,max:999999999999,precision:2,required:true,groupSeparator:','"/></td>
				</tr>
				<tr>
					<th>最近一笔贷款详情:</th>
		...
		<form id="creditCardsDetails-form" method="post">
			...
			<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
				...
				<tr>
					<th>授信总额:</th>
					<td><input name="creditTotalAmount" style="width: 100px;" class="easyui-validatebox easyui-numberbox" data-options="min:0,max:999999999999,precision:2,required:true,groupSeparator:','"/>元</td>
					<th>使用额度:</th>
					<td><input name="creditLimit" style="width: 100px;" class="easyui-validatebox easyui-numberbox" data-options="min:0,max:999999999999,precision:2,required:true,groupSeparator:','"/>元</td>
					<th>最高额度:</th>
					<td><input name="maxLimit" style="width: 100px;" class="easyui-validatebox easyui-numberbox" data-options="min:0,max:999999999999,precision:2,required:true,groupSeparator:','"/>元</td>
					<th>月还额度:</th>
					<td><input name="monthRepay" style="width: 100px;" class="easyui-validatebox easyui-numberbox" data-options="min:0,max:999999999999,precision:2,required:true,groupSeparator:','"/>元</td>
				</tr>
				<tr>
					<th>年内逾期:</th>
					...
					<th>使用年限:</th>
					<td><input name="validateYear" style="width: 100px;"  class="easyui-validatebox easyui-textbox" data-options="min:0,max:9999,required:true"/></td>
					<th>最高期数:</th>
					<td><input name="maxQishu" style="width: 100px;"  class="easyui-validatebox easyui-numberbox" data-options="min:0,max:9999,required:true"/></td>
				</tr>
				<tr>
					<th>使用率:</th>
	...
	<div title="资质分析">
		<form id="firstAuditReport-form" method="post" style="height:570px;">
			...
			<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
				...
				<tr>
					<th>备注:</th>
					<td colspan="5"><textarea name="note" style="width:94%;height:70px;" class="easyui-validatebox easyui-validatebox" data-options="required:true,validType:'length[0,300]'"></textarea></td>
				</tr>
				<tr>
					<th>初审人:</th>
					<td>
				...
				<tr>
					<th>初审人员意见:</th>
					<td colspan="5"><textarea name="firsPersSugg" style="width:94%;height:70px;" class="easyui-validatebox easyui-textbox" data-options="required:true,validType:'length[0,10]'"></textarea></td>
				</tr>
				<tr>
					<th>初审部门意见:</th>
					<td colspan="5"><textarea name="firsDepSugg" style="width:94%;height:70px;" class="easyui-validatebox easyui-textbox" data-options="required:true,validType:'length[0,512]'"></textarea></td>
				</tr>
				
				<tr>
					<th>初审资质分析说明:</th>
					<td colspan="5"><textarea name="description" style="width:94%;height:70px;" class="easyui-validatebox easyui-textbox" data-options="required:true,validType:'length[0,1024]'"></textarea></td>
				</tr>
				<tr>
