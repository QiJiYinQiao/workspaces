			...
			success : function(data) {
				if (data) {
					...
					$.each(data,function(i,item) {
						...
						htmlC += "<td><input name='accountIds' value='"+item.accountId+"' type='hidden'/><input name='bankNames' class='easyui-textbox easyui-validatebox' data-options='validType:\"length[0,80]\"' value='"+item.bankName+"'/></td>";
						htmlC += "<th>开户行户名</th>";
						htmlC += "<td><input name='accountNames' class='easyui-textbox easyui-validatebox' data-options='validType:\"length[0,32]\"' value='"+item.accountName+"'/></td>";
						htmlC += "<th>开户行账号</th>";
						htmlC += "<td><input name='accountNums' class='easyui-textbox easyui-validatebox' data-options='validType:\"length[0,32]\"' value='"+item.accountNum+"'/></td>";
						htmlC += "</tr>";
					});
