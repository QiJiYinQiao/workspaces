...
<script type="text/javascript">
	...
	//导出赎回客户明细报表
	function toExportExcel4RedeemInvestorDetails(flag){
		
		var exportExcelUrl = "";
		
		if(flag == 'exportAll'){
			console.info("exportAll Reports");
			exportExcelUrl = "investRedeem/investRedeemAction!exportExcel4RedeemInvestorFinancialDetails.action?investOrderId=";
		}
		else if(flag == 'exportOne'){
			console.info("exportOne Reports");		
			exportExcelUrl = "investRedeem/investRedeemAction!exportExcel4RedeemInvestorFinancialDetails.action?investOrderId="+investOrderId;
		}
...
<!-- 	<div style="height: 280px;overflow: auto;" > -->
	...
	<div style="width: 880px;height:30px;">
		<a style="margin-left: 350px;" href="javascript:void(0);" class="easyui-linkbutton" onclick="toExportExcel4RedeemInvestorDetails('exportOne')">导出本条赎回客户名单</a>
		<a style="margin-left: 30px;" href="javascript:void(0);" class="easyui-linkbutton" onclick="toExportExcel4RedeemInvestorDetails('exportAll')">导出全部赎回客户名单</a>
		<a style="margin-left: 30px;" href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('ShuJuZhuanYuanTongGuo',this);">办理完毕</a>
	</div>
