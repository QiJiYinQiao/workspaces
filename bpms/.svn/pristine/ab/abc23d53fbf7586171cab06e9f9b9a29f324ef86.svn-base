...
/**
 * @Creater chenfl
 * @File_Name LoanProcessStartTaskListener.java
 * @Version v1.0
...
public class LoanProcessStartExecutionListener implements ExecutionListener {
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		// 修改订单的状态的信息
		loanOrderService.updateLoanOrderProcessStatus(id, "1");
	}
