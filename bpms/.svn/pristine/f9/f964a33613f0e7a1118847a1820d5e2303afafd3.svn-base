...
<div data-options="region:'north',title:'North Title',split:true">
	...
	<div style="width: 980px;height:30px;">
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('JieSuanZhuanYuanThrough');">结算专员通过</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('JieSuanZhuanYuanReject');">结算专员驳回</a>
	</div>
