...
<div class="well well-small" style="margin-left: 5px;margin-top: 5px;width: 700px;">
	  <form id="loanInfo">
	    <table class="table">
			<tr>
				<th>申请额度(元):</th>
				<td><input name="loanAmount" class="easyui-validatebox easyui-numberbox" data-options="min:0,precision:2,max:999999999999,groupSeparator:',',required:true" />
				<th>最低接受额度(元):</th>
				<td><input name="loanMin" class="easyui-validatebox easyui-numberbox" data-options="min:0,precision:2,max:999999999999,required:true,groupSeparator:','"/></td>
			</tr>
			<tr>
				<th>申请贷款期限(月):</th>
			...
			<tr>
			    ...
			    <th>业务员:</th>
				<td>
					<!-- <input name="salesMan" class="easyui-textbox easyui-validatebox" data-options="required:true,validType:'length[0,40]'"/> -->
					<input name="salesMan" class="easyui-validatebox easyui-textbox"  value="<%=shiroUser.getUser().getName() %>" readonly="readonly"/>
				</td>
			</tr>
			<tr>
				<th>贷款用途:</th>
