		...
		<form id="assets-form" method="post" style="height:580px;">
			...
			<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
				...
				<tr>
					...
					<td><textarea name="realEstate" class="easyui-textbox easyui-validatebox" style="width:99%;" data-options='required:true'></textarea></td>
				</tr>
				<tr>
					<th>车产:</th>
					<td><textarea name="vehicle" class="easyui-textbox easyui-validatebox" style="width:99%;" data-options='required:true'></textarea></td>
				</tr>
				<tr>
					<th>同行业:</th>
					<td><input name="theSameIndustry" class="easyui-textbox" style="width:99%;" /></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<div title="资质分析">
		...
		<form id="firstAuditReport-form" method="post" style="height:580px;">
			...
			<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
				...
				<tr>
					<th>备注:</th>
					<td colspan="5"><textarea name="note" style="width:94%;height:70px;" class="easyui-textbox" ></textarea></td>
				</tr>
				<tr>
					<th>初审人:</th>
					<td>
				...
				<tr>
					<th>初审人员意见:</th>
					<td colspan="5"><textarea name="firsPersSugg" style="width:94%;height:70px;" class="easyui-textbox" ></textarea></td>
				</tr>
				<tr>
					<th>初审部门意见:</th>
					<td colspan="5"><textarea name="firsDepSugg" style="width:94%;height:70px;" class="easyui-textbox" ></textarea></td>
				</tr>
				
				<tr>
					<th>初审资质分析说明:</th>
					<td colspan="5"><textarea name="firstDescription" style="width:94%;height:70px;" class="easyui-textbox" ></textarea></td>
				</tr>
			</table>
		</form>
		...
		<form id="finalAuditReportForm" method="post">
			...
			<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
				...
				<tr>
					<th>终审人员意见:</th>
					<td colspan="5"><textarea name="finaPersSugg" style="width:94%;height:70px;" class="easyui-textbox" ></textarea></td>
				</tr>
				<tr>
					<th>终审资质分析说明:</th>
					<td colspan="5"><textarea name="finalDescription" style="width:94%;height:70px;" class="easyui-textbox" ></textarea></td>
				</tr>
				<tr>
