$(function() {
	var procdef_datagrid = $('#process_definition').datagrid({
		// 获取数据
		url : 'workflow/workflowAction!getAllProcessDefinition.action',
		width : 'auto',
	...
	procrep_toolbar={
			...
			showImage:function(resourceName,deploymentId){
				...
				var src = "workflow/workflowAction!getDiagramResource.action?resourceName="+resourceName+"&deploymentId="+deploymentId;
