...
public class CreditInvestigation implements java.io.Serializable {
	...
	public CreditInvestigation(String carId, String creditRefId,
			Integer selfQuery, Integer loanApproval,
			Integer creditCardApproval, Integer internetQuery,
			String queryInterval, String queryNotes) {
		super();
		this.carId = carId;
		this.creditRefId = creditRefId;
