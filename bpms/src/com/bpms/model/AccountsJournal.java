...
public class AccountsJournal implements java.io.Serializable {
	...
	public AccountsJournal(String bankFlowId, String carId,
			String bankaccountNo, String bankaccountType, Integer monName01,
			Integer monName02, Integer monName03, Integer monName04,
			Integer monName05, Integer monName06, BigDecimal income01,
			BigDecimal income02, BigDecimal income03, BigDecimal income04,
			BigDecimal income05, BigDecimal income06, BigDecimal averageIncome,
			String analysis) {
		super();
		this.bankFlowId = bankFlowId;
		this.carId = carId;
