...
public class Constants {
	...
	/** 借款业务流程各角色ID */
	// 业务员
	public static final String LOAN_ORDER_CODE_FINANCIALMANAGER = "1000";
	// 初审
	public static final String LOAN_ROLE_CODE_INITIALAUDIT = "1001";
	// IPC
	public static final String LOAN_ROLE_CODE_IPCAUDIT = "1002";
	// 外访
	public static final String LOAN_ROLE_CODE_VISIT = "1003";
	// 终审
	public static final String LOAN_ROLE_CODE_FINALAUDIT = "1004";
	// 审批主管
	public static final String LOAN_ROLE_CODE_APPROVALMGR = "1005";
	// 审批经理
	public static final String LOAN_ROLE_CODE_APPROVALLEADER = "1006";
	// 签约人
	public static final String LOAN_ROLE_CODE_SIGNATORY = "1007";
	// 结算中心
	public static final String LOAN_ROLE_CODE_ACCOUNTINGDEPT = "1008";
	// 贷后管理
	public static final String LOAN_ROLE_CODE_LOANMANAGEMENT = "1009";
	// 贷审委1
	public static final String LOAN_ROLE_CODE_LRC01 = "10010";
	// 贷审委2
	public static final String LOAN_ROLE_CODE_LRC02 = "10011";
	// 贷审委3
	public static final String LOAN_ROLE_CODE_LRC03 = "10012";
	// IPC部门经理
	public static final String LOAN_ROLE_CODE_IPCMGR = "10013";
	// 车贷主管
	public static final String LOAN_ROLE_CODE_CARLOANMGR = "10014";
	// 数据岗
	public static final String LOAN_ROLE_CODE_DATAPOST = "10015";
	// 流程启动者流程变量key
	...
	// 部门助理
	public static final String INVEST_ROLE_CODE_DEPTASSISTANT = "10016";
	// 销客专员
	public static final String INVEST_ROLE_CODE_SALESCUSTCOMM = "10017";
	// 销客主管
	public static final String INVEST_ROLE_CODE_SALESCUSTMANAGER = "10018";

	/** 结算中心 **/
	public static final String INVEST_ROLE_CODE_ACCOUNTINGDEPT = "1008";

	public static final String INVEST_ROLE_CODE_FINANCIALMANAGER = "10019";
