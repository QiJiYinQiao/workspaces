	...
	function lookAttachment(index){
		...
		<div data-options="region:'north',title:'North Title',split:true">
			...
			<div style="width: 880px;height:30px;">
				...
				<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-redo" onclick="submitTask('InvestApplyResubmit',this);">订单重提</a>
				<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" onclick="submitTask('InvestApplyRevoke',this);">订单撤销</a>				
			</div>
