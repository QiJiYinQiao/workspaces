...
<!-- 	<div style="height: 280px;overflow: auto;" > -->
	...
	<div style="width: 880px;height:30px;">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('YingYeBuJingLiTongGuo',this);">审批通过</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('YingYeBuJingLiBoHui',this);">审批驳回</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('YingYeBuJingLiJuJue',this);">审批拒绝</a>
	</div>
