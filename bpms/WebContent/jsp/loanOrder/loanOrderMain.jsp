...
<script type="text/javascript">
	...
	$(function() {
		$grid =$("#dg").datagrid({
					...
					columns : [ [
							...
							{field : 'repayMethod',title : '还款方式',width : 80,align : 'center',formatter:function(value, row, index){
	...
	function addRowsOpenDlg() {
		$("<div></div>").dialog({
			...
			width: 900,
			height:650,
			href : "jsp/loanOrder/loanOrderAddForm.jsp",
			onClose:function(){
				$(this).dialog("destroy");
				$grid.datagrid('reload');
			}
