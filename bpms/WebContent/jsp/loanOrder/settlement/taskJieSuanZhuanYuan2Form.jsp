...
<style type="text/css">
	...
	.table th{ text-align: left;width:80px;height:20px;padding-left: 8px;padding-top: 8px;font-weight: bold;}
...
<div data-options="region:'north',title:'North Title',split:true">
	...
	<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('JieSuanZhuanYuan2Through');">结算专员通过</a>
	<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('JieSuanZhuanYuan2Reject');">结算专员驳回</a>
	</div>
