...
<div data-options="region:'north',title:'North Title',split:true">
	...
	<div style="width: 980px;height:30px;">
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('ApprovalLeaderThrough');">审批经理通过</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('ApprovalLeaderRefuse');">审批经理拒贷</a>
	</div>	
