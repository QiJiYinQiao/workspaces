		...
		<div title="资质分析">
			<form id="finalAuditReport-form" method="post">
				...
				<table class="table" style="margin-top: 10px;width:100%;" cellpadding="5px;">
					...
					<tr>
						<th>终审人员意见:</th>
						<td colspan="5"><textarea id="finaPersSugg" name="finaPersSugg" style="width:95%;height:70px;" class="easyui-validatebox easyui-textbox" data-options="required:true"></textarea></td>
					</tr>
					<tr>
						<th>终审资质分析说明:</th>
						<td colspan="5"><textarea id="description" name="description" style="width:95%;height:70px;" class="easyui-validatebox easyui-textbox" data-options="required:true"></textarea></td>
					</tr>
					<tr>
