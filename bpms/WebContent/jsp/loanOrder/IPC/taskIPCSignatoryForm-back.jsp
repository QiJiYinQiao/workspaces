...
$(function(){
	...
	function saveContract(){
		...
		$loanContract  = $("<div></div>").dialog({
			...
			width: 1000,
			height:650,
			href : "jsp/loanOrder/loanContractForm.jsp",
			onClose:function(){
				$(this).dialog("destroy");
			}
		});
...
<!-- <div data-options="region:'north',title:'North Title',split:true">
	...
	<div style="width:980px;height:30px;">
		<div id="carInfoDiv" style="display: inline;">
	 ...
	 <form id="contactForm" method="post">
		...
		<table class="table">
			<tr>
				...
				<td><input class="txtDate" name="contractSignDate" /></td>
				<th>共同贷款人签字日期:</th>
			...
			<tr>
			    ...
			    <th>还款结束日期:</th>
				<td>
				   <input class="txtDate" name="repaymentEdDate" />
				</td>
				<th>贷款结束日期:</th>
			    <td>
