...
public class PurchaseAppModel implements java.io.Serializable,Cloneable{
	...
	public PurchaseAppModel(String ids) {
		super();
		this.ids = ids;
	}
	...
	public PurchaseAppModel(int paId, String appNo, String appType,
			...
			Date appDate, String appStatus, String totalAmt,
	...
	public String getTotalAmtMini() {
		return totalAmtMini;
	}
	public void setTotalAmtMini(String totalAmtMini) {
		this.totalAmtMini = totalAmtMini;
	}
	public String getTotalAmtMax() {
		return totalAmtMax;
	}
	public void setTotalAmtMax(String totalAmtMax) {
