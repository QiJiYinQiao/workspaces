...
public class PenaltyNoticeSubmitAppStartExecutionListener implements ExecutionListener {
	...
	public void notify(DelegateExecution execution) throws Exception {
		if(execution.getVariable(Constants.CURRENT_BUSINESS_ID) != null){
			...
			penaltyNoticeSubmitAppService.updatePenaltyNoticeSubmitAppProceStatus(id, Constants.PROC_APPROVAL);
		}
	}
}
