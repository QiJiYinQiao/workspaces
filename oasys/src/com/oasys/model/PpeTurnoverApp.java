...
public class PpeTurnoverApp implements java.io.Serializable {
	...
	@Transient
	public String getPpeTotalAmtStr() {
		return ppeTotalAmtStr;
	}

	public void setPpeTotalAmtStr(String ppeTotalAmtStr) {
		this.ppeTotalAmtStr = ppeTotalAmtStr;
	}
