...
public class BadgeApp implements java.io.Serializable {
	...
	public BadgeApp(Integer pnrId, Integer registrantNo, Date regDatetime,
			String appNo, Date appDate, String appStatus, String procStatus,
			String remark, String regName, String appDateS, String appDateE,
			String appStateName, String definitionKey, String myId,
			Integer deptNo, String fullName, Long number, Long total) {
		super();
		this.pnrId = pnrId;
