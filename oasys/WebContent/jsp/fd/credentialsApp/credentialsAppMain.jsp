	...
	$(function() {
		...
		$grid =$("#travelExpensesAppgrid").datagrid({
					...
					columns : [ [
							...
							{field : 'procStatus',title : '申请状态',width :parseInt($(this).width()*0.06),align : 'center'},
	...
	function saveOrUpdOpenDlg(index) {
		var row = this.getRowData($grid,index);
		 $saveOrUpdbanliDialog = $("#saveDialog").dialog({
				...
				modal:true,
				href:"jsp/fd/credentialsApp/credentialsAppAdd.jsp?appNo='"+(index==null?"":row.appNo)+"'",
				onLoad:function(){
					if(index!=null){
...
// 								subCustomerRepaymentForm();
	...
	function showImage(index) {
		var row = this.getRowData($grid,index);
		var src = "LeaveApp/showLeaveProcess.do?teaId="+ row.teaId;
...
<body>
		<div style="margin-left: 5px;margin-top: 5px">
			<div class="position" style="margin-top: 5px;">您当前所在位置：业务管理-->财务管理-->证章申请</div>
		</div>
			...
			<form id="searchForm" action="credentialsApp/index.do" method="post">
				<table cellpadding="0" cellspacing="1" border="0">
					<tr>
						...
						<td>申请时间：&nbsp;&nbsp;</td>
						<td><input name="queryAppDateBegin" id="queryAppDateBegin" class="easyui-datebox" editable="true" style="width:174px;"/></td>
						<td>到：</td>
						<td><input name="queryAppDateEnd" id="queryAppDateEnd" class="easyui-datebox" editable="true" style="width:174px;"/></td>	
					...
					<tr>
						<td>实际使用日期：&nbsp;&nbsp;</td>
						<td><input name="queryUseDateBegin" id="queryUseDateBegin" class="easyui-datebox" editable="true" style="width:174px;"/></td>
						<td>到：&nbsp;&nbsp;</td>
						<td><input name="queryUseDateEnd" id="queryUseDateEnd" class="easyui-datebox" editable="true" style="width:174px;"/></td>
					</tr>									
				</table>
			</form>			  			
		</div>
