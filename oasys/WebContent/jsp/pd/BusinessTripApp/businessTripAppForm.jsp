    ...
    <legend><img src="extend/fromedit.png" style="margin-bottom: -3px;"/>基本信息</legend>
          ...
          <table  id="startIn" class="table">
             <tr>
                ...
                <th>职务代理人:</th>
                <td><input id="agentNo" name="agentNo" class="easyui-textbox easyui-validatebox"/></td>
             </tr>
             <tr>
		        <th>出差始发地:</th>
		     ...
		     <tr>
		        <th>计划出差开始时间:</th>
                <td><input id="planBgDtime" name="planBgDtime" class="easyui-datetimebox" required="required"/></td>
                <th>计划出差结束时间:</th>
                <td><input id="planEdDtime" name="planEdDtime" class="easyui-datetimebox"  required="required"/></td>
                <!-- <th>计划出差天数:</th>
             ...
             <tr>
		        <th>交通工具:</th>
                <td><input id="vehicle" name="vehicle" class="easyui-textbox" required="required"/></td>
