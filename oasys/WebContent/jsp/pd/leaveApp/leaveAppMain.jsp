	...
	$(function() {
		...
		$grid =$("#leaveAppgrid").datagrid({
					...
					columns : [ [
							...
							{field : 'position',title : '职位',width : parseInt($(this).width()*0.06),sortable : true,align : 'center',},
			                {field : 'leName',title : '请假种类',width:parseInt($(this).width()*0.06),align : 'center'},
			                {field : 'agentName',title : '职务代理人',width:parseInt($(this).width()*0.08),align : 'center',
								formatter : function(value, row, index) {
									return "<a href=\"javascript:void(0)\" onclick=\"showView("+ index + ");\">" + value + "</a>";
								}
							},
							{field : 'planLeDays',title : '计划休假时间',width:parseInt($(this).width()*0.1),align : 'center'},
							...
							{field : 'leReason',title : '请假事由',width : parseInt($(this).width()*0.06),align : 'center'},
...
<body>
		<div style="margin-left: 5px;margin-top: 5px">
			<div class="position" style="margin-top: 5px;">您当前所在位置：业务管理-->人力资源规划-->员工考勤-->休假申请</div>
		</div>
