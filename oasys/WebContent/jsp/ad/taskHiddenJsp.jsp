...
<script type="text/javascript" src="js/saveTaskJS/ad/saveTaskJavaScript.js"></script>
<!-- 需要加载的属性 -->
...
<div id="applyDiv">
	...
	<a href="javascript:void(0)" id="applyForAdjustmentSubmit" class="easyui-linkbutton"  onclick="saveTaskFunc(1);">申请重提</a>
   	<a href="javascript:void(0)" id="applyForAdjustmentBack" class="easyui-linkbutton"  onclick="saveTaskFunc(0);">申请撤销</a>
</div>
<div id="saveTaskDiv">
