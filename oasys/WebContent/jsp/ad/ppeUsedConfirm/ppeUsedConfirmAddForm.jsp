	  ...
	  <div class="well well-small" style="margin:5px;width:680px">
	         ...
	         <table class="table">
				 ...
				 <tr>
					<th>备注信息:</th>
					<td colspan="3">
					  <textarea id="remark" name="remark" class="easyui-textbox easyui-validatebox" style="width: 555px; height: 60px;resize:none;" data-options="validType:'length[0,100]'"></textarea>
					</td>
				</tr>
				<tr>
