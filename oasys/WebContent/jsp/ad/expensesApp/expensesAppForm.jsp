		   ...
		   <div title="费用申请信息" data-options="iconCls:'icon-cstbase'" style="padding: 10px">
		      <form id="expensesAppForm" novalidate="true">
		         ...
		         <table class="table">
		           <tr>
		              <th>费用类型:</th>
		              <td><input name="billType" class="easyui-textbox easyui-validatebox" editable="false" panelHeight="auto"/></td>
		           </tr>
		           <tr>
		              <th width="25%">申请金额:</th>
		              <td><input name="appAmt" class="easyui-textbox easyui-validatebox easyui-numberbox" data-options="required:true,min:0,precision:2,max:9999999,groupSeparator:','"/>(元)</td>
		              <th>支付方式:</th>
