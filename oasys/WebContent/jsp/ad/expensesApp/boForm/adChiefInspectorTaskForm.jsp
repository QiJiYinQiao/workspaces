...
function submitTask(result,object){
    if(result == "xingzhengzongjianbohui"){
		 ...
		 <table class="table" cellpadding="5px;">
			...
			<tr>
			    <td colspan="6">
					...
					<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('xingzhengzongjiantongguo',this);">申请通过</a>
					<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('xingzhengzongjianbohui',this);">申请驳回</a>
			    </td>
			</tr>
			<tr>
			    <td colspan="6">
