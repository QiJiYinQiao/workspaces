	...
	$.messager.confirm('提示', '点击按钮之后将进入下一个任务活动环节,此任务将对您不可见!', function(r){
		if (r){
			var data = {
				...
				"appNo":$row.appNo,
				"taskId":$row.taskId,
				"handleResult":result=='kuaijiquerentongguo'?1:0	//0驳回 1是通过
			}
			$.ajax({
				type:"POST",
		 ...
		 <table class="table" cellpadding="5px;">
			...
			<tr>
			    <td colspan="6">
						...
						<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('kuaijiquerentongguo',this);">申请通过</a>
			    </td>
			</tr>
			<tr>
			    <td colspan="6">
