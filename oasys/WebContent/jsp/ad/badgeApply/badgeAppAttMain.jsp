	...
	$(function() {
		...
		$grid =$("#badgeAppGrid").datagrid({
					...
					columns : [ [
							...
							{field : 'namePinyin',title : '英文姓名',width : parseInt($(this).width()*0.1),sortable : true,align : 'center'},
							{field : 'positionName',title : '职位',width:parseInt($(this).width()*0.07),align : 'center'},
							{field : 'regDatetime',title : '登记时间',width:parseInt($(this).width()*0.09),align : 'center'},  
...
<body>
		...
		<table id="badgeAppGrid" title="工牌申请管理"></table>
		<!-- 展示客户信息详情 -->
