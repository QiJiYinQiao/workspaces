...
<script type="text/javascript">
	...
	function findstampList(){
		$("#stampName").combobox({
			width:171,
			url:"UseStampApp/findStampLIst.do?stampType="+$("#useStampAttForm :input[type='radio']:checked").val()+"&appNo="+$("#appPeoNo").val(),
			valueField:'code',
		 	textFiled:'text',
		 	onLoadSuccess:function(data){
		 		//加一个全部
	  ...
	  <div class="well well-small" style="margin:5px;height: 270px" >
	         ...
	         <table class="table">
				...
				<tr>
					<th>用章事由:</th>
					<td colspan="3">
						<textarea id="useReason" name="useReason" class="easyui-textbox easyui-validatebox" maxlength="100"style="width: 540px;height: 80px;resize:none;" data-options="required:true,validType:'length[1,200]'"></textarea>
					</td>
				</tr>
				 ...
				 <tr>
					<th>备注信息:</th>
					<td colspan="3">
					  <textarea id="attRemark" name="remark" class="easyui-textbox easyui-validatebox" maxlength="100"  style="width: 540px; height: 80px;resize:none;" data-options="validType:'length[0,200]'"></textarea>
					</td>
				</tr>
				<tr>
