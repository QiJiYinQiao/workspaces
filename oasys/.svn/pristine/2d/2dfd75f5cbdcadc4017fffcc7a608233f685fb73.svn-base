    ...
    <input id="applyStr" name="applyStr" type="hidden"  value="<%= Constants.APPLY_FOR_ADJUSTMENT %>" />
    	<input id="btaId" name="btaId" type="hidden"/>
 		<table class="table"  width="95%">
				...
				<tr>
			        <th>实际出差开始时间:</th>
	                <td><input id="realBgDtime" name="realBgDtime" editable="false" class="easyui-datetimebox"  required="required"/></td>
	                <th>实际出差结束时间:</th>
	                <td><input id="realEdDtime" name="realEdDtime" editable="false" class="easyui-datetimebox"  required="required"/></td>
	             </tr>
				<tr>
					<td colspan="1"></td>
