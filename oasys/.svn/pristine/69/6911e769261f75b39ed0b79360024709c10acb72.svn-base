	...
	<script type="text/javascript">
			...
			<%String definitionKey=request.getParameter("key");%>//流程变量
		 	$(function() {
				 ...
				 $grid=$dg.datagrid({
					...
					columns : [ [
								{field : 'efaId',        title : '编号',    width : 0, align:'center'},
				 	 			...
				 	 			{field : 'curDeptName',        title : 'curDeptName',    width : 0, align:'center' },
				...
				$('#dg').datagrid('hideColumn','curDeptName');
  ...
  <body>
      <div data-options="region:'center',border : false">
		...
		<div id="tb" style="padding:2px 0">
			<a id="id4ExportReports" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="toSaveOrUpdateEmpSal('');">新增</a>
		</div>
		<!-- 表格区域 -->
