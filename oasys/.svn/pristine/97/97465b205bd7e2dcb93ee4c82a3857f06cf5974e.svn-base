		...
		$dialog = $("<div></div>").dialog({
			...
			buttons : [ {
				...
				handler : function() {
					...
					$("input[name='userNames']").val(userNames.join(","));
				...
				<input name="userIds" id="userIds" type="hidden"/>
				 <table>
					 <tr>
						...
						<th>收件人</th>
						<td>
						<input name="userNames" id="userNames" type="text"  class="easyui-textbox"disabled="disabled"/>&nbsp;&nbsp;<a id="addRes" href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-add" plain="false" onclick="addReceiver();">添加收件人</a></td>
					 </tr>
					 <tr>
						<th>通知级别</th>
