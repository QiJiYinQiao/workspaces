...
<style>
.frame_head{ width:100%;height:61px; background:url(extend/head_bg.jpg) repeat-x; overflow:hidden;}
...
.frame_head_admin_box{ height:24px;font-size:12px; margin:23px 0 0 980px; line-height:24px; background:#fff;opacity: 0.7;filter: progid:DXImageTransform.Microsoft.Alpha(opacity=70); -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(opacity=70)";}
...
.admin_font{ font-weight:bold;}
    ...
    <div class="frame_head">
		...
		<span style="position: absolute;left:250px; top: 23px; font: 25px bold;font-family: '微软雅黑'">钱钱金融OA办公系统-OASYS</span>
    	<div class="frame_head_admin">
        	<table cellpadding="0" cellspacing="0" border="0" class="frame_head_admin_box" style="width: 100%">
            	<tr>
                	...
                	<td >欢迎您:<span class="admin_font" style="margin-right: 10px; color: red;"><%=user.getName() %></span><span id="time"></span></td>
                    <td ></td>
