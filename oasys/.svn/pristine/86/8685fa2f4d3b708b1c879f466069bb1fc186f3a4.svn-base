...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#reverter").combobox("setValue",$selRow.reverter);
			...
			<input id="applicantNo" name="applicantNo" type="hidden"/><!-- 申请人id -->
			 ...
			 <table class="table"  width="95%">
				 <tr>
					...
					<th>归还人:</th>
					<td ><input name="reverter" id="reverter" type="text" class="easyui-textbox  easyui-combobox easyui-validatebox"  style="width: 170px" />&nbsp;</td>
				</tr>
