...
<script type="text/javascript">
	...
	function editForm(from){
		...
		$("#"+from+" a[iconCls^='icon-save']").css('display','inline-block');
		//解除禁用
	  ...
	  <div class="well well-small" style="margin:5px;width:680px">
	         ...
	         <table class="table">
	          	<tr>
					...
					<td>
						<input id="grantExp" name="grantExp"  type="text" style="width: 90px;text-align: center;" value="0" disabled="disabled" class="easyui-textbox easyui-validatebox easyui-numberbox" precision="2" data-options="required:true,editable:false,groupSeparator:','">&nbsp;元</input>
					</td>
	         	 </tr>
				 <tr>
					<th>支付款项:</th>
					<td colspan="3">
					  <textarea id="clause" name="clause" class="easyui-textbox easyui-validatebox" style="width: 606px; height: 60px;resize:none;" data-options="required:true,validType:'length[1,100]'"></textarea>
					</td>
				 </tr>
				 ...
				 <tr>
	         	 	...
	         	 	<td>
	         	 		<input id="total" name="total"  type="text" style="width: 90px;text-align: center;"  class="easyui-textbox easyui-validatebox easyui-numberbox" precision="2" data-options="required:true,min:0,max:99999999.99,groupSeparator:',',editable:false" onchange="valimonnumber();">&nbsp;元</input>
	         	 	</td>
	         	 </tr>
				...
				<tr>
				   <td colspan="6" style="text-align: right;">
					  ...
					  <a id="checkAttachment" href="javascript:void(0);" class="easyui-linkbutton" >查看附件</a>
				   	  <a href="javascript:void(0)" id="save" class="easyui-linkbutton" iconCls="icon-save" onclick="toSaveBaseInfo('expendFrom');">保存</a>
