	...
	$.messager.confirm('提示', '点击按钮之后将进入下一个任务活动环节,此任务将对您不可见!', function(r){
		if (r){
			var data = {
				...
				"appNo":$row.appNo,
				"taskId":$row.taskId,
				"handleResult":result=='bumenzhuguantongguo'?1:result=="bumenzhuguanbohui"?0:2
			}
			$.ajax({
				type:"POST",
		 ...
		 <table class="table" cellpadding="5px;">
			<tr>
				...
				<tr>
					<th>实际开始日期时间:</th>
					<td>
						<input id="realBgDtime" name="realBgDtime" class="easyui-textbox easyui-datetimebox" data-options="validType:'length[0,100]', required:true" disabled="disabled" disabled="disabled"/>
					</td>
					<th>实际结束日期时间:</th>
					<td>
			...
			<tr>
				<td colspan="8">
					...
					<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('bumenzhuguantongguo',this);">申请通过</a>
					<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('bumenzhuguanbohui',this);">申请驳回</a>
					<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('bumenzhuguanjujue',this);">申请拒绝</a>
				</td>
			</tr>
			<tr>
				<td colspan="8">
