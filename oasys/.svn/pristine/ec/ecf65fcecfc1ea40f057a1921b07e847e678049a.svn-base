	...
	function createStaffRecruitAppInfoGrid(){
		$datagrid = $("#staffRecruitAppInfoGrid").datagrid({
			...
			columns:[[
			        ...
			        {field : 'curLoginUserName', title : '申请人',      width : parseInt($(this).width()*0.06), align : 'center'},
			        {field : 'deptName',       title : '申请部门',     width : parseInt($(this).width()*0.1), align : 'center'},
	                ...
	                {field : 'recruitPlace',   title : '招聘渠道',     width : parseInt($(this).width()*0.08), align : 'center', formatter:function(value, row, index){
	                	if(  value == "1" ){
	                		return "从公司外部招聘";
	                	}else if( value == "2" ){
	                		return "从公司内部调配";
	                ...
	                {field : 'recruitPurpose', title : '招聘目的',     width : parseInt($(this).width()*0.08), align : 'center', formatter:function(value, row, index){
	                	if(  value == "1" ){
	                		return "补充新人";
	                	}else if( value == "2" ){
	                		return "替换现职员";
	                ...
	                {field : 'appStatusName',      title : '申请状态',    width : parseInt($(this).width()*0.08), align : 'center', formatter:function(value,row,index){
	                	if(value == null || value == ""){
	                		return "初始状态";
	                	}
	                	return value;
