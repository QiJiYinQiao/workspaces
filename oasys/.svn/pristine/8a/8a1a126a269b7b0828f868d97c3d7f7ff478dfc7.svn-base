...
<html>
  <head>
	...
	function badgeCollecGrid(){
		
		//获取key值
		$grid =$("#collec").datagrid({
					...
					columns : [ [
							        ...
							        {field : 'fullName',title : '申请部门',width:parseInt($(this).width()*0.07),align : 'center'},
									{field : 'number',title : '数量',width:parseInt($(this).width()*0.07),align : 'center'},
									{field : 'appDate',title : '申请日期',width:parseInt($(this).width()*0.09),align : 'center'},   
  ...
  <body>
      <div data-options="region:'center',border : false">
  		<div class="well well-small" style="margin-left: 5px;margin-top: 5px">
				<div id="task" class="position" style="margin-top: 5px;">您当前所在位置：业务管理-->工牌申请-->代办任务</div>
				<div id="collecList" class="position" style="margin-top: 5px;">您当前所在位置：业务管理-->工牌申请-->汇总表</div>
		</div>
		<!-- 高级查询栏区域 -->
  		<div  class="well well-small" style="margin-left: 5px;margin-top: 5px">
