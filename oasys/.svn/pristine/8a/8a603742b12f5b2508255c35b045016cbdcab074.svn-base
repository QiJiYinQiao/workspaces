 ...
 */
public class BusinessTripAppTaskListener extends BaseTaskListener implements TaskListener{
	...
	public void notify(DelegateTask task) {
		...
		if(task.getTaskDefinitionKey().startsWith(Constants.APPLY_FOR_ADJUSTMENT) || task.getTaskDefinitionKey().startsWith("ChuChaiQueRen")){
