...
function submitTask(result,object){
    if(result == "xingzhengduijiezhulibohui"){
		 ...
		 <table class="table" cellpadding="5px;">
			...
			<tr>
			    <td colspan="6">
					...
					<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('xingzhengduijiezhulitongguo',this);">申请通过</a>
					<a href="javascript:void(0);" class="easyui-linkbutton" onclick="submitTask('xingzhengduijiezhulibohui',this);">申请驳回</a>
			    </td>
			</tr>
			<tr>
			    <td colspan="6">
