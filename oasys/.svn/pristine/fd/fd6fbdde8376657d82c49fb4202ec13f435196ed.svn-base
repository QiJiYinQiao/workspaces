			...
			<table class="table"  width="95%">
				...
				<tr>
				   ...
				   <a id="upploadAttachment" href="javascript:void(0);" class="easyui-linkbutton" >上传附件</a>	
				      ...
				      <a href="javascript:void(0)" id="save" class="easyui-linkbutton" iconCls="icon-save" onclick="saveTaskFunc('RenLiZiYuanZongJianTongGuo',1);">申请通过</a>
				      <a href="javascript:void(0)" id="rset" class="easyui-linkbutton" onclick="saveTaskFunc('RenLiZiYuanZongJianBoHui',0);">申请驳回</a>
				      <a href="javascript:void(0)" id="end" class="easyui-linkbutton" onclick="saveTaskFunc('RenLiZiYuanZongJianJuJue',2);">申请拒绝</a>
				   </td>
				</tr>					
			</table>
		</form>
