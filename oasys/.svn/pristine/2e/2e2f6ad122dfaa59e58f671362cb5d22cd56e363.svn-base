...
<html>
  ...
  <body>
     ...
     <div class="position" style="margin-top: 5px;">您当前所在位置： 人力资源  &gt; 员工离职 </div>
     <div class="well well-small" style="margin-left: 5px;margin-top: 5px">
			<form id="searchForm" action="empDimissionAppController/findEmpDimissionAppList" method="post" style="min-width: 1200px;">
