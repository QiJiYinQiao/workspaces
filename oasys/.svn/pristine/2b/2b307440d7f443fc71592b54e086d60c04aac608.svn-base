<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <input name="ptaId" class="easyui-numberbox" type="hidden"/>
          ...
          <table>
             <tr>
                <th>交接日期:</th>
                <td><input id="concedeDate" name="concedeDate" class="easyui-textbox  easyui-validatebox" disabled="disabled"/></td>
                <th>接收部门:</th>
                <td><input id="takeoverDeptName" name="takeoverDeptName" class="easyui-textbox" required disabled="disabled"/>
                	<input id="takeoverDept" name="takeoverDept" type="hidden"/>
                </td>
                <th>接收人:</th>
                <td><input id="takeoverUserName" name="takeoverUserName" class="easyui-textbox easyui-combobox easyui-validatebox" disabled="disabled"/>
                	<input id="takeoverUser" name="takeoverUser" type="hidden"/>
                </td>
             </tr>
             <tr>
             	<th>交接事由:</th>
             	<td><input id="concedeReson" name="concedeReson" class="easyui-textbox easyui-validatebox" required>
             	<th>交接地点:</th>
             	<td><input id="concedeAddr" name="concedeAddr" class="easyui-textbox easyui-validatebox" required>
             </tr>
             <tr>
