...
function createPpeScrapAttachGrid(){
	$("#ppeScrapAttachGrid").datagrid({
		...
		columns:[[
			...
			{field : 'ppeNo',        title : '资产编号',    width : parseInt(ppeListWidth * 0.1), align:'center' },
			{field : 'ppeName',      title : '资产名称', width : parseInt(ppeListWidth*0.09), align:'center'},
			{field : 'ppeModel',    title : '资产规格',    width : parseInt(ppeListWidth*0.09), align:'center' },
			{field : 'buyDate',    title : '购买时间',    width : parseInt(ppeListWidth*0.09), align:'center',formatter: 
			...
			{field : 'caozuo',    title : '操作',    width : parseInt(ppeListWidth*0.1), align:'center',
