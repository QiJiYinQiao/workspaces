...
public interface PublicDao<T> {
	 ...
	 * 
	 * @author:xujianwei
	 * @time:2015年11月12日 下午6:08:22
	 * @Title:findTotalCount1
	 * @Description:TODO（这里描述这个方法的作用）
	 * @param sql
	 * @return
	 * @throws:
	 */
	public Long findTotalCount1(String sql);
	/**
	 * 带事务的hql执行
	 * 
	 * @param hql
	 ...
	 * @author WANGXINCHENG
	 * @return BigDecimal
	 * @date 2015年11月9日 下午1:48:26
	 * @throws
	 */
	BigDecimal getNumber(String sql);

	BigInteger getDays(String sql);
}
