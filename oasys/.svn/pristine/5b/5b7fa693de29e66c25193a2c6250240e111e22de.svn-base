...
/**
 * TOaFdExpendVoucherApp generated by hbm2java
 * 支出凭单表
 */
@Entity
@Table(name = "t_oa_fd_expend_voucher_app", catalog = "oasys", uniqueConstraints = @UniqueConstraint(columnNames = "APP_NO"))
public class ExpendVoucherApp implements java.io.Serializable,Cloneable {

	private Integer evaId;
	private String appNo;
	private String jkAppNo;
	...
	public ExpendVoucherApp(Integer evaId, String appNo, Integer applicantNo, String jkAppNo,
			Date appDate, String appStatus, String clause, BigDecimal total,
			BigDecimal grantExp, BigDecimal supplyAmt, BigDecimal givebackAmt,
			String procStatus, String remark, String applicationName,
			String appDateS, String appDateE, String roleCode,
			String deptLeave, WorkFlowTasksModel taskModel, String result,
