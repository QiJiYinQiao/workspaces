...
function createWaitTaskGrid(){
	$("#waitTaskGrid").datagrid({
		url:'callingCard/QueryCardTask.do?processKey=<%=Constants.CALLINGCARD_BO%>',
		width: 'auto',
		...
		columns:[[
			...
			{field : 'sumAppQty',    title : '总和',    width : parseInt($(this).width * 0.1), align:'center' },
...
function showImage(index){
	...
	data : "busID="+selectedRow.uqaId+"&definitionKey=CallingCardBO",
	dataType:'JSON',
	success : function(iJson) {		  
 		var src = "workflowAction/showProcessImg.do?taskId="+iJson+"&imgName="+<%=Constants.CALLINGCARD_BO%>;
