...
<html>
				...
				if (row) {
					$("#dd").dialog({
						...
						//	createUser('baseForm');
							...
							$("#appDate").val(row.appDate.split(" ")[0]);
						//	alert(row.appDate.split(" ")[0]);把appDate转成date类型
  ...
  <body>
     ...
     <div class="position" style="margin-top: 5px;">您当前所在位置：人力资源规划 &gt; 员工考勤 &gt; 出差申请 </div>
     <div class="well well-small" style="margin-left: 5px;margin-top: 5px">
			<form id="searchForm" action="businessTripApp/findBusinessTripAppList" method="post" style="min-width: 1200px;">
