	   ...
	   <input type="hidden" id="psaId" name="psaId" class="easyui-textbox"  value="${ppeAttach.psaId}"/>
			...
			<table class="table"  width="95%">
				...
				<tr>
					...
					<th>资产净值:</th>
					<td><input id="ppeNet" name="ppeNet"  value="${ppeAttach.ppeNet}"   class="easyui-numberbox easyui-textbox easyui-validatebox"  data-options="required:true,min:1,max:99999,precision:2,groupSeparator:','"  type="text" />&nbsp;(元)</td>				
					<th>资产残值:</th>
					<td><input id="ppeSalvageVal" name="ppeSalvageVal"  value="${ppeAttach.ppeSalvageVal}"   class="easyui-numberbox  easyui-textbox easyui-validatebox"  data-options="required:true,min:1,max:99999,precision:2,groupSeparator:','"  type="text" />&nbsp;(元)</td>										
				</tr>
				<tr>
