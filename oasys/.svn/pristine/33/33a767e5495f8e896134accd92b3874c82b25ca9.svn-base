...
<form id="empRosterRegForm" method="post" style="width: auto;margin-left:5px;">
	...
	<input name="workedDays" type="hidden"/>
	    ...
	    <table>
	      <tr>
	        <th>试用期<br/>基本工资:</th>
	        <td><input name="trialBaseSal" class="easyui-textbox"/></td>
	        <th>试用期<br/>岗位工资:</th>
	        <td><input name="trialPostSal" class="easyui-textbox easyui-validatebox"/></td>
	        <th>试用期<br/>绩效工资:</th>
	        <td><input name="trialPerfSal" class="easyui-textbox"/></td>
	      </tr>
	      <tr>
	        <th>转正<br/>基本工资:</th>
	        <td><input name="regularBaseSal" class="easyui-textbox easyui-validatebox"/></td>
	        <th>转正<br/>岗位工资:</th>
	        <td><input name="regularPostSal" class="easyui-textbox easyui-validatebox"/></td>
	        <th>转正<br/>绩效工资:</th>
	        <td><input name="regularPerfSal" class="easyui-textbox easyui-validatebox"/></td>
	      </tr>
	      <tr>
	        <th>本月最终<br/>薪资合计:</th>
	        <td><input name="curMonthSalCnt" class="easyui-textbox"/></td>
	       </tr>
	      </table>
	      </fieldset>
	      <fieldset>
	     ...
	     <table>
	      <tr>
	        ...
	        <th>劳动合同<br/>期限:</th>
	        <td><input name="contractPeriod" class="easyui-textbox"/>年</td>
	      </tr>
	      <tr>
	        <th>劳动合同<br/>开始时间:</th>
	      ...
	      <tr>
	        <th>养老保险:</th>
	        <td><input name="endowmentIns" class="easyui-textbox easyui-validatebox"/></td>
	        <th>医疗保险:</th>
	        <td><input name="medicalIns" class="easyui-textbox"/></td>
	        <th>失业保险:</th>
	        <td><input name="unemploymentIns" class="easyui-textbox easyui-numberbox"/></td>
	      </tr>
	      <tr>
	        <th>工伤保险:</th>
	        <td><input name="workInjuryIns" class="easyui-textbox"/></td>
	        <th>生育保险:</th>
	        <td><input name="maternityIns" class="easyui-textbox easyui-validatebox"/></td>
	        <th>社保公积金:</th>
	        <td><input name="housingFund" class="easyui-textbox"/></td>
	      </tr>
	    </table>
	    </fieldset>
	    <fieldset>
