	     ...
	     <form id="travelOtherFrom" >
	         ...
	         <table class="table">
				 ...
				 <tr>
				 	 <th>合计金额：</th>
					 <td>
					 	<input id="total" name="total"  type="text" style="width: 50px;text-align: center;" value="0" precision="2" class="easyui-textbox easyui-validatebox easyui-numberbox" data-options="required:true,editable:false" >元</input>
					 </td>
				</tr>
				<tr>
